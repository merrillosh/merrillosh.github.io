                ...
                return function(e) {
                    ...
                    function o(e, t, i) {
                        ...
                        if (t) {
                            ...
                            (h || c) && (a = new s.CommentHandler, a.attach = c, t.comment = !0, u = o)
                        }
                        var l, p = !1;
                        t && "string" === typeof t.sourceType && (p = "module" === t.sourceType), l = t && "boolean" === typeof t.jsx && t.jsx ? new n.JSXParser(e, t, u) : new r.Parser(e, t, u);
                        var d = p ? l.parseModule() : l.parseScript(),
                            m = d;
                        return h && a && (m.comments = a.comments), l.config.tokens && (m.tokens = l.tokens), l.config.tolerant && (m.errors = l.errorHandler.errors), m
                    }
                    ...
                    function c(e, t, i) {
                        var s, n = new a.Tokenizer(e, t);
                        s = [];
                        try {
                            while (1) {
                                var r = n.getNextToken();
                                if (!r) break;
                                i && (r = i(r)), s.push(r)
                            }
                        } catch (o) {
                            n.errorHandler.tolerate(o)
                        }
                        return n.errorHandler.tolerant && (s.errors = n.errors()), s
                    }
                    t.parse = o, t.parseModule = u, t.parseScript = h, t.tokenize = c;
                    var l = i(2);
                            ...
                            return e.prototype.insertInnerComments = function(e, t) {
                                if (e.type === s.Syntax.BlockStatement && 0 === e.body.length) {
                                    for (var i = [], n = this.leading.length - 1; n >= 0; --n) {
                                        ...
                                        t.end.offset >= r.start && (i.unshift(r.comment), this.leading.splice(n, 1), this.trailing.splice(n, 1))
                                    }
                                ...
                                if (n && n.node.trailingComments) {
                                    var r = n.node.trailingComments[0];
                                    r && r.range[0] >= e.end.offset && (t = n.node.trailingComments, delete n.node.trailingComments)
                                }
                                return t
                                ...
                                while (this.stack.length > 0) {
                                    ...
                                    if (!(s && s.start >= e.start.offset)) break;
                                    t = s.node, this.stack.pop()
                                }
                                if (t) {
                                    for (var n = t.leadingComments ? t.leadingComments.length : 0, r = n - 1; r >= 0; --r) {
                                        var a = t.leadingComments[r];
                                        a.range[1] <= e.start.offset && (i.unshift(a), t.leadingComments.splice(r, 1))
                                    }
                                    return t.leadingComments && 0 === t.leadingComments.length && delete t.leadingComments, i
                                }
                                for (r = this.leading.length - 1; r >= 0; --r) {
                                    s = this.leading[r];
                                    s.start <= e.start.offset && (i.unshift(s.comment), this.leading.splice(r, 1))
                                }
                                return i
                                ...
                                if (!(e.type === s.Syntax.Program && e.body.length > 0)) {
                                    ...
                                    n.length > 0 && (e.leadingComments = n), i.length > 0 && (e.trailingComments = i), this.stack.push({
                                        node: e,
                                ...
                                if (e.range && (s.range = e.range), e.loc && (s.loc = e.loc), this.comments.push(s), this.attach) {
                                    var n = {
                                        comment: {
                                            type: i,
                                            value: e.value,
                                    ...
                                    e.loc && (n.comment.loc = e.loc), e.type = i, this.leading.push(n), this.trailing.push(n)
                                }
                    ...
                    function l(e) {
                        ...
                        switch (e.type) {
                            ...
                            case a.JSXSyntax.JSXNamespacedName:
                                var s = e;
                                t = l(s.namespace) + ":" + l(s.name);
                                break;
                            case a.JSXSyntax.JSXMemberExpression:
                                var n = e;
                                t = l(n.object) + "." + l(n.property);
                                break;
                            default:
                                break
                        }
                    ...
                    var p = function(e) {
                        ...
                        return s(t, e), t.prototype.parsePrimaryExpression = function() {
                            ...
                            var t = "&",
                                ...
                                r = !1,
                                a = !1;
                            while (!this.scanner.eof() && i && !s) {
                                var o = this.scanner.source[this.scanner.index];
                                if (o === e) break;
                                if (s = ";" === o, t += o, ++this.scanner.index, !s) switch (t.length) {
                                    case 2:
                                        r = "#" === o;
                                        break;
                                    case 3:
                                        r && (a = "x" === o, i = a || n.Character.isDecimalDigit(o.charCodeAt(0)), r = r && !a);
                                        break;
                                    default:
                                        i = i && !(r && !n.Character.isDecimalDigit(o.charCodeAt(0))), i = i && !(a && !n.Character.isHexDigit(o.charCodeAt(0)));
                                        break
                                }
                            }
                            if (i && s && t.length > 2) {
                            ...
                            if (34 === e || 39 === e) {
                                var i = this.scanner.index,
                                    s = this.scanner.source[this.scanner.index++],
                                    r = "";
                                while (!this.scanner.eof()) {
                                    var a = this.scanner.source[this.scanner.index++];
                                    if (a === s) break;
                                    r += "&" === a ? this.scanXHTMLEntity(s) : a
                                }
                                return {
                                    type: 8,
                                    value: r,
                            ...
                            if (46 === e) {
                                ...
                                t = 46 === o && 46 === u ? "..." : ".", i = this.scanner.index;
                            ...
                            if (n.Character.isIdentifierStart(e) && 92 !== e) {
                                i = this.scanner.index;
                                ++this.scanner.index;
                                while (!this.scanner.eof()) {
                                    a = this.scanner.source.charCodeAt(this.scanner.index);
                                    if (n.Character.isIdentifierPart(a) && 92 !== a) ++this.scanner.index;
                                    else {
                                        if (45 !== a) break;
                                        ++this.scanner.index
                                    }
                            ...
                            var e = this.createJSXNode(),
                                t = this.nextJSXToken();
                            return 100 !== t.type && this.throwUnexpectedToken(t), this.finalize(e, new r.JSXIdentifier(t.value))
                            ...
                            if (this.matchJSX(":")) {
                                ...
                                t = this.finalize(e, new r.JSXNamespacedName(i, s))
                            } else if (this.matchJSX("."))
                                while (this.matchJSX(".")) {
                                    var n = t;
                                    this.expectJSX(".");
                                    var a = this.parseJSXIdentifier();
                                    t = this.finalize(e, new r.JSXMemberExpression(n, a))
                                }
                            return t
                            ...
                            if (this.matchJSX(":")) {
                                ...
                                e = this.finalize(t, new r.JSXNamespacedName(s, n))
                            } else e = i;
                            return e
                            ...
                            return this.reenterJSX(), this.finalize(e, new r.JSXExpressionContainer(t))
                            ...
                            var e = this.createJSXNode(),
                                ...
                                i = null;
                            return this.matchJSX("=") && (this.expectJSX("="), i = this.parseJSXAttributeValue()), this.finalize(e, new r.JSXAttribute(t, i))
                        }, t.prototype.parseJSXSpreadAttribute = function() {
                            var e = this.createJSXNode();
                            this.expectJSX("{"), this.expectJSX("..."), this.finishJSX();
                            var t = this.parseAssignmentExpression();
                            return this.reenterJSX(), this.finalize(e, new r.JSXSpreadAttribute(t))
                            ...
                            var t = this.parseJSXElementName(),
                                ...
                                s = this.matchJSX("/");
                            return s && this.expectJSX("/"), this.expectJSX(">"), this.finalize(e, new r.JSXOpeningElement(t, s, i))
                        }, t.prototype.parseJSXBoundaryElement = function() {
                            var e = this.createJSXNode();
                            if (this.expectJSX("<"), this.matchJSX("/")) {
                                this.expectJSX("/");
                                var t = this.parseJSXElementName();
                                return this.expectJSX(">"), this.finalize(e, new r.JSXClosingElement(t))
                            }
                            var i = this.parseJSXElementName(),
                                s = this.parseJSXAttributes(),
                                n = this.matchJSX("/");
                            return n && this.expectJSX("/"), this.expectJSX(">"), this.finalize(e, new r.JSXOpeningElement(i, n, s))
                        }, t.prototype.parseJSXEmptyExpression = function() {
                            var e = this.createJSXChildNode();
                            return this.collectComments(), this.lastMarker.index = this.scanner.index, this.lastMarker.line = this.scanner.lineNumber, this.lastMarker.column = this.scanner.index - this.scanner.lineStart, this.finalize(e, new r.JSXEmptyExpression)
                        }, t.prototype.parseJSXExpressionContainer = function() {
                            var e, t = this.createJSXNode();
                            return this.expectJSX("{"), this.matchJSX("}") ? (e = this.parseJSXEmptyExpression(), this.expectJSX("}")) : (this.finishJSX(), e = this.parseAssignmentExpression(), this.reenterJSX()), this.finalize(t, new r.JSXExpressionContainer(e))
                            ...
                            while (!this.scanner.eof()) {
                                ...
                                if (i.start < i.end) {
                                    var s = this.getTokenRaw(i),
                                        n = this.finalize(t, new r.JSXText(i.value, s));
                                    e.push(n)
                                }
                            ...
                            while (!this.scanner.eof()) {
                                ...
                                if (s.type === a.JSXSyntax.JSXOpeningElement) {
                                    var n = s;
                                    if (n.selfClosing) {
                                        var o = this.finalize(i, new r.JSXElement(n, [], null));
                                        e.children.push(o)
                                    } else t.push(e), e = {
                                        node: i,
                                        opening: n,
                                ...
                                if (s.type === a.JSXSyntax.JSXClosingElement) {
                                    ...
                                    var u = l(e.opening.name),
                                        h = l(e.closing.name);
                                    if (u !== h && this.tolerateError("Expected corresponding JSX closing tag for %0", u), !(t.length > 0)) break;
                                    o = this.finalize(e.node, new r.JSXElement(e.opening, e.children, e.closing));
                                    e = t[t.length - 1], e.children.push(o), t.pop()
                                }
                            }
                            return e
                            ...
                            if (!t.selfClosing) {
                                ...
                                i = n.children, s = n.closing
                            }
                            return this.finalize(e, new r.JSXElement(t, i, s))
                    ...
                    var s = i(6),
                        n = function() {
                            function e(e) {
                                this.type = s.JSXSyntax.JSXClosingElement, this.name = e
                            }
                            return e
                        }();
                    ...
                    var r = function() {
                        function e(e, t, i) {
                            this.type = s.JSXSyntax.JSXElement, this.openingElement = e, this.children = t, this.closingElement = i
                        }
                        return e
                    }();
                    t.JSXElement = r;
                    ...
                    var o = function() {
                        function e(e) {
                            this.type = s.JSXSyntax.JSXExpressionContainer, this.expression = e
                        }
                        return e
                    }();
                    ...
                    var u = function() {
                        function e(e) {
                            this.type = s.JSXSyntax.JSXIdentifier, this.name = e
                        }
                        return e
                    }();
                    t.JSXIdentifier = u;
                    var h = function() {
                        function e(e, t) {
                            this.type = s.JSXSyntax.JSXMemberExpression, this.object = e, this.property = t
                        }
                        return e
                    }();
                    ...
                    var c = function() {
                        function e(e, t) {
                            this.type = s.JSXSyntax.JSXAttribute, this.name = e, this.value = t
                        }
                        return e
                    }();
                    t.JSXAttribute = c;
                    var l = function() {
                        function e(e, t) {
                            this.type = s.JSXSyntax.JSXNamespacedName, this.namespace = e, this.name = t
                        }
                        return e
                    }();
                    ...
                    var p = function() {
                        function e(e, t, i) {
                            this.type = s.JSXSyntax.JSXOpeningElement, this.name = e, this.selfClosing = t, this.attributes = i
                        }
                        return e
                    }();
                    ...
                    var d = function() {
                        function e(e) {
                            this.type = s.JSXSyntax.JSXSpreadAttribute, this.argument = e
                        }
                        return e
                    }();
                    ...
                    var m = function() {
                        function e(e, t) {
                            this.type = s.JSXSyntax.JSXText, this.value = e, this.raw = t
                        }
                        return e
                    }();
                    t.JSXText = m
                    ...
                    var s = i(2),
                        n = function() {
                            function e(e) {
                                this.type = s.Syntax.ArrayExpression, this.elements = e
                            }
                            return e
                        }();
                    t.ArrayExpression = n;
                    var r = function() {
                        function e(e) {
                            this.type = s.Syntax.ArrayPattern, this.elements = e
                        }
                        return e
                    }();
                    t.ArrayPattern = r;
                    var a = function() {
                        function e(e, t, i) {
                            this.type = s.Syntax.ArrowFunctionExpression, this.id = null, this.params = e, this.body = t, this.generator = !1, this.expression = i, this.async = !1
                        }
                        return e
                    }();
                    ...
                    var o = function() {
                        function e(e, t, i) {
                            this.type = s.Syntax.AssignmentExpression, this.operator = e, this.left = t, this.right = i
                        }
                        return e
                    }();
                    ...
                    var u = function() {
                        function e(e, t) {
                            this.type = s.Syntax.AssignmentPattern, this.left = e, this.right = t
                        }
                        return e
                    }();
                    ...
                    var h = function() {
                        function e(e, t, i) {
                            this.type = s.Syntax.ArrowFunctionExpression, this.id = null, this.params = e, this.body = t, this.generator = !1, this.expression = i, this.async = !0
                        }
                        return e
                    }();
                    ...
                    var c = function() {
                        function e(e, t, i) {
                            this.type = s.Syntax.FunctionDeclaration, this.id = e, this.params = t, this.body = i, this.generator = !1, this.expression = !1, this.async = !0
                        }
                        return e
                    }();
                    ...
                    var l = function() {
                        function e(e, t, i) {
                            this.type = s.Syntax.FunctionExpression, this.id = e, this.params = t, this.body = i, this.generator = !1, this.expression = !1, this.async = !0
                        }
                        return e
                    }();
                    ...
                    var p = function() {
                        function e(e) {
                            this.type = s.Syntax.AwaitExpression, this.argument = e
                        }
                        return e
                    }();
                    t.AwaitExpression = p;
                    var d = function() {
                        function e(e, t, i) {
                            var n = "||" === e || "&&" === e;
                            this.type = n ? s.Syntax.LogicalExpression : s.Syntax.BinaryExpression, this.operator = e, this.left = t, this.right = i
                        }
                        return e
                    }();
                    ...
                    var m = function() {
                        function e(e) {
                            this.type = s.Syntax.BlockStatement, this.body = e
                        }
                        return e
                    }();
                    t.BlockStatement = m;
                    var x = function() {
                        function e(e) {
                            this.type = s.Syntax.BreakStatement, this.label = e
                        }
                        return e
                    }();
                    t.BreakStatement = x;
                    var D = function() {
                        function e(e, t) {
                            this.type = s.Syntax.CallExpression, this.callee = e, this.arguments = t
                        }
                        return e
                    }();
                    t.CallExpression = D;
                    var f = function() {
                        function e(e, t) {
                            this.type = s.Syntax.CatchClause, this.param = e, this.body = t
                        }
                        return e
                    }();
                    t.CatchClause = f;
                    ...
                    var y = function() {
                        function e(e, t, i) {
                            this.type = s.Syntax.ClassDeclaration, this.id = e, this.superClass = t, this.body = i
                        }
                        return e
                    }();
                    ...
                    var C = function() {
                        function e(e, t, i) {
                            this.type = s.Syntax.ClassExpression, this.id = e, this.superClass = t, this.body = i
                        }
                        return e
                    }();
                    t.ClassExpression = C;
                    var A = function() {
                        function e(e, t) {
                            this.type = s.Syntax.MemberExpression, this.computed = !0, this.object = e, this.property = t
                        }
                        return e
                    }();
                    ...
                    var v = function() {
                        function e(e, t, i) {
                            this.type = s.Syntax.ConditionalExpression, this.test = e, this.consequent = t, this.alternate = i
                        }
                        return e
                    }();
                    ...
                    var S = function() {
                        function e(e) {
                            this.type = s.Syntax.ContinueStatement, this.label = e
                        }
                        return e
                    }();
                    ...
                    var g = function() {
                        function e(e, t) {
                            this.type = s.Syntax.ExpressionStatement, this.expression = e, this.directive = t
                        }
                        return e
                    }();
                    t.Directive = g;
                    var k = function() {
                        function e(e, t) {
                            this.type = s.Syntax.DoWhileStatement, this.body = e, this.test = t
                        }
                        return e
                    }();
                    ...
                    var B = function() {
                        function e(e) {
                            this.type = s.Syntax.ExportAllDeclaration, this.source = e
                        }
                        return e
                    }();
                    ...
                    var b = function() {
                        function e(e) {
                            this.type = s.Syntax.ExportDefaultDeclaration, this.declaration = e
                        }
                        return e
                    }();
                    ...
                    var T = function() {
                        function e(e, t, i) {
                            this.type = s.Syntax.ExportNamedDeclaration, this.declaration = e, this.specifiers = t, this.source = i
                        }
                        return e
                    }();
                    ...
                    var N = function() {
                        function e(e, t) {
                            this.type = s.Syntax.ExportSpecifier, this.exported = t, this.local = e
                        }
                        return e
                    }();
                    t.ExportSpecifier = N;
                    var I = function() {
                        function e(e) {
                            this.type = s.Syntax.ExpressionStatement, this.expression = e
                        }
                        return e
                    }();
                    ...
                    var M = function() {
                        function e(e, t, i) {
                            this.type = s.Syntax.ForInStatement, this.left = e, this.right = t, this.body = i, this.each = !1
                        }
                        return e
                    }();
                    t.ForInStatement = M;
                    var P = function() {
                        function e(e, t, i) {
                            this.type = s.Syntax.ForOfStatement, this.left = e, this.right = t, this.body = i
                        }
                        return e
                    }();
                    t.ForOfStatement = P;
                    var X = function() {
                        function e(e, t, i, n) {
                            this.type = s.Syntax.ForStatement, this.init = e, this.test = t, this.update = i, this.body = n
                        }
                        return e
                    }();
                    t.ForStatement = X;
                    var J = function() {
                        function e(e, t, i, n) {
                            this.type = s.Syntax.FunctionDeclaration, this.id = e, this.params = t, this.body = i, this.generator = n, this.expression = !1, this.async = !1
                        }
                        return e
                    }();
                    ...
                    var U = function() {
                        function e(e, t, i, n) {
                            this.type = s.Syntax.FunctionExpression, this.id = e, this.params = t, this.body = i, this.generator = n, this.expression = !1, this.async = !1
                        }
                        return e
                    }();
                    ...
                    var z = function() {
                        function e(e, t, i) {
                            this.type = s.Syntax.IfStatement, this.test = e, this.consequent = t, this.alternate = i
                        }
                        return e
                    }();
                    t.IfStatement = z;
                    var O = function() {
                        function e(e, t) {
                            this.type = s.Syntax.ImportDeclaration, this.specifiers = e, this.source = t
                        }
                        return e
                    }();
                    ...
                    var R = function() {
                        function e(e) {
                            this.type = s.Syntax.ImportDefaultSpecifier, this.local = e
                        }
                        return e
                    }();
                    ...
                    var K = function() {
                        function e(e) {
                            this.type = s.Syntax.ImportNamespaceSpecifier, this.local = e
                        }
                        return e
                    }();
                    ...
                    var j = function() {
                        function e(e, t) {
                            this.type = s.Syntax.ImportSpecifier, this.local = e, this.imported = t
                        }
                        return e
                    }();
                    t.ImportSpecifier = j;
                    var H = function() {
                        function e(e, t) {
                            this.type = s.Syntax.LabeledStatement, this.label = e, this.body = t
                        }
                        return e
                    }();
                    ...
                    var W = function() {
                        function e(e, t) {
                            this.type = s.Syntax.Literal, this.value = e, this.raw = t
                        }
                        return e
                    }();
                    t.Literal = W;
                    var G = function() {
                        function e(e, t) {
                            this.type = s.Syntax.MetaProperty, this.meta = e, this.property = t
                        }
                        return e
                    }();
                    t.MetaProperty = G;
                    var _ = function() {
                        function e(e, t, i, n, r) {
                            this.type = s.Syntax.MethodDefinition, this.key = e, this.computed = t, this.value = i, this.kind = n, this.static = r
                        }
                        return e
                    }();
                    ...
                    var Y = function() {
                        function e(e) {
                            this.type = s.Syntax.Program, this.body = e, this.sourceType = "module"
                        }
                        return e
                    }();
                    t.Module = Y;
                    var V = function() {
                        function e(e, t) {
                            this.type = s.Syntax.NewExpression, this.callee = e, this.arguments = t
                        }
                        return e
                    }();
                    t.NewExpression = V;
                    var q = function() {
                        function e(e) {
                            this.type = s.Syntax.ObjectExpression, this.properties = e
                        }
                        return e
                    }();
                    ...
                    var $ = function() {
                        function e(e) {
                            this.type = s.Syntax.ObjectPattern, this.properties = e
                        }
                        return e
                    }();
                    t.ObjectPattern = $;
                    var Z = function() {
                        function e(e, t, i, n, r, a) {
                            this.type = s.Syntax.Property, this.key = t, this.computed = i, this.value = n, this.kind = e, this.method = r, this.shorthand = a
                        }
                        return e
                    }();
                    t.Property = Z;
                    var Q = function() {
                        function e(e, t, i, n) {
                            this.type = s.Syntax.Literal, this.value = e, this.raw = t, this.regex = {
                                pattern: i,
                                flags: n
                            }
                        }
                    ...
                    var ee = function() {
                        function e(e) {
                            this.type = s.Syntax.RestElement, this.argument = e
                        }
                        return e
                    }();
                    t.RestElement = ee;
                    var te = function() {
                        function e(e) {
                            this.type = s.Syntax.ReturnStatement, this.argument = e
                        }
                        return e
                    }();
                    ...
                    var ie = function() {
                        function e(e) {
                            this.type = s.Syntax.Program, this.body = e, this.sourceType = "script"
                        }
                        return e
                    }();
                    t.Script = ie;
                    var se = function() {
                        function e(e) {
                            this.type = s.Syntax.SequenceExpression, this.expressions = e
                        }
                        return e
                    }();
                    ...
                    var ne = function() {
                        function e(e) {
                            this.type = s.Syntax.SpreadElement, this.argument = e
                        }
                        return e
                    }();
                    t.SpreadElement = ne;
                    var re = function() {
                        function e(e, t) {
                            this.type = s.Syntax.MemberExpression, this.computed = !1, this.object = e, this.property = t
                        }
                        return e
                    }();
                    ...
                    var oe = function() {
                        function e(e, t) {
                            this.type = s.Syntax.SwitchCase, this.test = e, this.consequent = t
                        }
                        return e
                    }();
                    t.SwitchCase = oe;
                    var ue = function() {
                        function e(e, t) {
                            this.type = s.Syntax.SwitchStatement, this.discriminant = e, this.cases = t
                        }
                        return e
                    }();
                    ...
                    var he = function() {
                        function e(e, t) {
                            this.type = s.Syntax.TaggedTemplateExpression, this.tag = e, this.quasi = t
                        }
                        return e
                    }();
                    ...
                    var ce = function() {
                        function e(e, t) {
                            this.type = s.Syntax.TemplateElement, this.value = e, this.tail = t
                        }
                        return e
                    }();
                    ...
                    var le = function() {
                        function e(e, t) {
                            this.type = s.Syntax.TemplateLiteral, this.quasis = e, this.expressions = t
                        }
                        return e
                    }();
                    ...
                    var de = function() {
                        function e(e) {
                            this.type = s.Syntax.ThrowStatement, this.argument = e
                        }
                        return e
                    }();
                    t.ThrowStatement = de;
                    var me = function() {
                        function e(e, t, i) {
                            this.type = s.Syntax.TryStatement, this.block = e, this.handler = t, this.finalizer = i
                        }
                        return e
                    }();
                    t.TryStatement = me;
                    var xe = function() {
                        function e(e, t) {
                            this.type = s.Syntax.UnaryExpression, this.operator = e, this.argument = t, this.prefix = !0
                        }
                        return e
                    }();
                    ...
                    var De = function() {
                        function e(e, t, i) {
                            this.type = s.Syntax.UpdateExpression, this.operator = e, this.argument = t, this.prefix = i
                        }
                        return e
                    }();
                    ...
                    var fe = function() {
                        function e(e, t) {
                            this.type = s.Syntax.VariableDeclaration, this.declarations = e, this.kind = t
                        }
                        return e
                    }();
                    ...
                    var Ee = function() {
                        function e(e, t) {
                            this.type = s.Syntax.VariableDeclarator, this.id = e, this.init = t
                        }
                        return e
                    }();
                    ...
                    var ye = function() {
                        function e(e, t) {
                            this.type = s.Syntax.WhileStatement, this.test = e, this.body = t
                        }
                        return e
                    }();
                    t.WhileStatement = ye;
                    var Ce = function() {
                        function e(e, t) {
                            this.type = s.Syntax.WithStatement, this.object = e, this.body = t
                        }
                        return e
                    }();
                    t.WithStatement = Ce;
                    var Ae = function() {
                        function e(e, t) {
                            this.type = s.Syntax.YieldExpression, this.argument = e, this.delegate = t
                        }
                        return e
                    }();
                    ...
                    var s = i(9),
                        ...
                        l = function() {
                            function e(e, t, i) {
                                ...
                                }, this.config.loc && t.source && null !== t.source && (this.config.source = String(t.source)), this.delegate = i, this.errorHandler = new n.ErrorHandler, this.errorHandler.tolerant = this.config.tolerant, this.scanner = new o.Scanner(e, this.errorHandler), this.scanner.trackComment = this.config.comment, this.operatorPrecedence = {
                                    ")": 0,
                                    ";": 0,
                                    ",": 0,
                                    "=": 0,
                            ...
                            return e.prototype.throwError = function(e) {
                                ...
                                var n = Array.prototype.slice.call(arguments, 1),
                                    r = e.replace(/%(\d)/g, (function(e, t) {
                                        return s.assert(t < n.length, "Message reference must be in range"), n[t]
                                    })),
                                    a = this.lastMarker.index,
                                    o = this.lastMarker.line,
                                    u = this.lastMarker.column + 1;
                                throw this.errorHandler.createError(a, o, u, r)
                                ...
                                var n = Array.prototype.slice.call(arguments, 1),
                                    ...
                                    u = this.lastMarker.column + 1;
                                this.errorHandler.tolerateError(a, o, u, r)
                            }, e.prototype.unexpectedTokenError = function(e, t) {
                                var i, s = t || r.Messages.UnexpectedToken;
                                if (e ? (t || (s = 2 === e.type ? r.Messages.UnexpectedEOS : 3 === e.type ? r.Messages.UnexpectedIdentifier : 6 === e.type ? r.Messages.UnexpectedNumber : 8 === e.type ? r.Messages.UnexpectedString : 10 === e.type ? r.Messages.UnexpectedTemplate : r.Messages.UnexpectedToken, 4 === e.type && (this.scanner.isFutureReservedWord(e.value) ? s = r.Messages.UnexpectedReserved : this.context.strict && this.scanner.isStrictModeReservedWord(e.value) && (s = r.Messages.StrictReservedWord))), i = e.value) : i = "ILLEGAL", s = s.replace("%0", i), e && "number" === typeof e.lineNumber) {
                                    var n = e.start,
                                        a = e.lineNumber,
                                        o = this.lastMarker.index - this.lastMarker.column,
                                        u = e.start - o + 1;
                                    return this.errorHandler.createError(n, a, u, s)
                                }
                                n = this.lastMarker.index, a = this.lastMarker.line, u = this.lastMarker.column + 1;
                                return this.errorHandler.createError(n, a, u, s)
                                ...
                                if (this.config.comment) {
                                    ...
                                    if (e.length > 0 && this.delegate)
                                        for (var t = 0; t < e.length; ++t) {
                                            ...
                                            }, this.config.range && (s.range = i.range), this.config.loc && (s.loc = i.loc);
                                            var n = {
                                                start: {
                                ...
                                var n = e.call(this);
                                return null !== this.context.firstCoverInitializedNameError && this.throwUnexpectedToken(this.context.firstCoverInitializedNameError), this.context.isBindingElement = t, this.context.isAssignmentTarget = i, this.context.firstCoverInitializedNameError = s, n
                                ...
                                this.context.isBindingElement = !0, this.context.isAssignmentTarget = !0, this.context.firstCoverInitializedNameError = null;
                                var n = e.call(this);
                                return this.context.isBindingElement = this.context.isBindingElement && t, this.context.isAssignmentTarget = this.context.isAssignmentTarget && i, this.context.firstCoverInitializedNameError = s || this.context.firstCoverInitializedNameError, n
                                ...
                                switch (this.lookahead.type) {
                                    case 3:
                                        (this.context.isModule || this.context.await) && "await" === this.lookahead.value && this.tolerateUnexpectedToken(this.lookahead), e = this.matchAsyncFunction() ? this.parseFunctionExpression() : this.finalize(s, new a.Identifier(this.nextToken().value));
                                        break;
                                    case 6:
                                    case 8:
                                        this.context.strict && this.lookahead.octal && this.tolerateUnexpectedToken(this.lookahead, r.Messages.StrictOctalLiteral), this.context.isAssignmentTarget = !1, this.context.isBindingElement = !1, t = this.nextToken(), i = this.getTokenRaw(t), e = this.finalize(s, new a.Literal(t.value, i));
                                        break;
                                    case 1:
                                        this.context.isAssignmentTarget = !1, this.context.isBindingElement = !1, t = this.nextToken(), i = this.getTokenRaw(t), e = this.finalize(s, new a.Literal("true" === t.value, i));
                                        break;
                                    case 5:
                                        this.context.isAssignmentTarget = !1, this.context.isBindingElement = !1, t = this.nextToken(), i = this.getTokenRaw(t), e = this.finalize(s, new a.Literal(null, i));
                                        break;
                                    case 10:
                                    ...
                                    case 7:
                                        switch (this.lookahead.value) {
                                            ...
                                            case "/":
                                            case "/=":
                                                this.context.isAssignmentTarget = !1, this.context.isBindingElement = !1, this.scanner.index = this.startMarker.index, t = this.nextRegexToken(), i = this.getTokenRaw(t), e = this.finalize(s, new a.RegexLiteral(t.regex, i, t.pattern, t.flags));
                                                break;
                                            default:
                                        ...
                                        break;
                                    case 4:
                                        !this.context.strict && this.context.allowYield && this.matchKeyword("yield") ? e = this.parseIdentifierName() : !this.context.strict && this.matchKeyword("let") ? e = this.finalize(s, new a.Identifier(this.nextToken().value)) : (this.context.isAssignmentTarget = !1, this.context.isBindingElement = !1, this.matchKeyword("function") ? e = this.parseFunctionExpression() : this.matchKeyword("this") ? (this.nextToken(), e = this.finalize(s, new a.ThisExpression)) : e = this.matchKeyword("class") ? this.parseClassExpression() : this.throwUnexpectedToken(this.nextToken()));
                                        break;
                                    default:
                                        e = this.throwUnexpectedToken(this.nextToken())
                                }
                                ...
                                return this.context.strict && e.firstRestricted && this.tolerateUnexpectedToken(e.firstRestricted, e.message), this.context.strict && e.stricted && this.tolerateUnexpectedToken(e.stricted, e.message), this.context.strict = t, this.context.allowStrictDirective = i, s
                                ...
                                var s = this.parseFormalParameters(),
                                    n = this.parsePropertyMethod(s);
                                return this.context.allowYield = i, this.finalize(t, new a.FunctionExpression(null, s.params, n, e))
                                ...
                                var s = this.parseFormalParameters(),
                                    n = this.parsePropertyMethod(s);
                                return this.context.allowYield = t, this.context.await = i, this.finalize(e, new a.AsyncFunctionExpression(null, s.params, n))
                                ...
                                if (3 === s.type) {
                                    var p = s.value;
                                    this.nextToken(), u = this.match("["), l = !this.hasLineTerminator && "async" === p && !this.match(":") && !this.match("(") && !this.match("*") && !this.match(","), n = l ? this.parseObjectPropertyKey() : this.finalize(i, new a.Identifier(p))
                                } else this.match("*") ? this.nextToken() : (u = this.match("["), n = this.parseObjectPropertyKey());
                                var d = this.qualifiedPropertyName(this.lookahead);
                                if (3 === s.type && !l && "get" === s.value && d) t = "get", u = this.match("["), n = this.parseObjectPropertyKey(), this.context.allowYield = !1, o = this.parseGetterMethod();
                                else if (3 === s.type && !l && "set" === s.value && d) t = "set", u = this.match("["), n = this.parseObjectPropertyKey(), o = this.parseSetterMethod();
                                else if (7 === s.type && "*" === s.value && d) t = "init", u = this.match("["), n = this.parseObjectPropertyKey(), o = this.parseGeneratorMethod(), h = !0;
                                else if (n || this.throwUnexpectedToken(this.lookahead), t = "init", this.match(":") && !l) !u && this.isPropertyKey(n, "__proto__") && (e.value && this.tolerateError(r.Messages.DuplicateProtoProperty), e.value = !0), this.nextToken(), o = this.inheritCoverGrammar(this.parseAssignmentExpression);
                                else if (this.match("(")) o = l ? this.parsePropertyMethodAsyncFunction() : this.parsePropertyMethodFunction(), h = !0;
                                else if (3 === s.type) {
                                    p = this.finalize(i, new a.Identifier(s.value));
                                    if (this.match("=")) {
                                ...
                                return this.finalize(i, new a.Property(t, n, u, o, h, c))
                                ...
                                while (!this.match("}")) t.push(this.parseObjectProperty(i)), this.match("}") || this.expectCommaSeparator();
                                ...
                                i.push(s);
                                while (!s.tail) t.push(this.parseExpression()), s = this.parseTemplateElement(), i.push(s);
                                        ...
                                        if (this.context.isBindingElement = !0, e = this.inheritCoverGrammar(this.parseAssignmentExpression), this.match(",")) {
                                            ...
                                            while (2 !== this.lookahead.type) {
                                                ...
                                                if (this.nextToken(), this.match(")")) {
                                                    this.nextToken();
                                                    for (var r = 0; r < n.length; r++) this.reinterpretExpressionAsPattern(n[r]);
                                                    s = !0, e = {
                                                        type: c,
                                                        params: n,
                                                        async: !1
                                                    ...
                                                    this.context.isBindingElement || this.throwUnexpectedToken(this.lookahead), n.push(this.parseRestElement(i)), this.expect(")"), this.match("=>") || this.expect("=>"), this.context.isBindingElement = !1;
                                                    for (r = 0; r < n.length; r++) this.reinterpretExpressionAsPattern(n[r]);
                                                    s = !0, e = {
                                                        type: c,
                                                        params: n,
                                                        async: !1
                                            ...
                                            s || (e = this.finalize(this.startNode(t), new a.SequenceExpression(n)))
                                        }
                                        if (!s) {
                                            if (this.expect(")"), this.match("=>") && (e.type === u.Syntax.Identifier && "yield" === e.name && (s = !0, e = {
                                                    type: c,
                                                    params: [e],
                                                    async: !1
                                                }), !s)) {
                                ...
                                if (s.assert("new" === i.name, "New expression must start with `new`"), this.match("."))
                                    ...
                                    e = new a.NewExpression(r, o), this.context.isAssignmentTarget = !1, this.context.isBindingElement = !1
                                }
                                ...
                                this.context.allowIn = !0, this.matchKeyword("super") && this.context.inFunctionBody ? (e = this.createNode(), this.nextToken(), e = this.finalize(e, new a.Super), this.match("(") || this.match(".") || this.match("[") || this.throwUnexpectedToken(this.lookahead)) : e = this.inheritCoverGrammar(this.matchKeyword("new") ? this.parseNewExpression : this.parsePrimaryExpression);
                                while (1)
                                    if (this.match(".")) {
                                        this.context.isBindingElement = !1, this.context.isAssignmentTarget = !0, this.expect(".");
                                        var n = this.parseIdentifierName();
                                        e = this.finalize(this.startNode(t), new a.StaticMemberExpression(e, n))
                                    } else if (this.match("(")) {
                                    ...
                                    if (e = this.finalize(this.startNode(t), new a.CallExpression(e, o)), r && this.match("=>")) {
                                    ...
                                    this.expect("]"), e = this.finalize(this.startNode(t), new a.ComputedMemberExpression(e, n))
                                } else {
                                ...
                                var e = this.startNode(this.lookahead),
                                    t = this.matchKeyword("super") && this.context.inFunctionBody ? this.parseSuper() : this.inheritCoverGrammar(this.matchKeyword("new") ? this.parseNewExpression : this.parsePrimaryExpression);
                                while (1)
                                    if (this.match("[")) {
                                        this.context.isBindingElement = !1, this.context.isAssignmentTarget = !0, this.expect("[");
                                ...
                                if (this.match("++") || this.match("--")) {
                                    var i = this.startNode(t),
                                        s = this.nextToken();
                                    e = this.inheritCoverGrammar(this.parseUnaryExpression), this.context.strict && e.type === u.Syntax.Identifier && this.scanner.isRestrictedWord(e.name) && this.tolerateError(r.Messages.StrictLHSPrefix), this.context.isAssignmentTarget || this.tolerateError(r.Messages.InvalidLHSInAssignment);
                                    var n = !0;
                                    e = this.finalize(i, new a.UpdateExpression(s.value, e, n)), this.context.isAssignmentTarget = !1, this.context.isBindingElement = !1
                                    ...
                                    this.context.strict && e.type === u.Syntax.Identifier && this.scanner.isRestrictedWord(e.name) && this.tolerateError(r.Messages.StrictLHSPostfix), this.context.isAssignmentTarget || this.tolerateError(r.Messages.InvalidLHSInAssignment), this.context.isAssignmentTarget = !1, this.context.isBindingElement = !1;
                                ...
                                if (this.match("+") || this.match("-") || this.match("~") || this.match("!") || this.matchKeyword("delete") || this.matchKeyword("void") || this.matchKeyword("typeof")) {
                                    var t = this.startNode(this.lookahead),
                                        i = this.nextToken();
                                    e = this.inheritCoverGrammar(this.parseUnaryExpression), e = this.finalize(t, new a.UnaryExpression(i.value, e)), this.context.strict && "delete" === e.operator && e.argument.type === u.Syntax.Identifier && this.tolerateError(r.Messages.StrictDelete), this.context.isAssignmentTarget = !1, this.context.isBindingElement = !1
                                ...
                                var t, i = e.value;
                                return t = 7 === e.type ? this.operatorPrecedence[i] || 0 : 4 === e.type && ("instanceof" === i || this.context.allowIn && "in" === i) ? 7 : 0, t
                                ...
                                if (s > 0) {
                                    ...
                                    var n = [e, this.lookahead],
                                        ...
                                        h = [s];
                                    while (1) {
                                        if (s = this.binaryPrecedence(this.lookahead), s <= 0) break;
                                        while (u.length > 2 && s <= h[h.length - 1]) {
                                            o = u.pop();
                                            var c = u.pop();
                                            h.pop(), r = u.pop(), n.pop();
                                            var l = this.startNode(n[n.length - 1]);
                                            u.push(this.finalize(l, new a.BinaryExpression(c, r, o)))
                                        }
                                        u.push(this.nextToken().value), h.push(s), n.push(this.lookahead), u.push(this.isolateCoverGrammar(this.parseExponentiationExpression))
                                    }
                                    var p = u.length - 1;
                                    t = u[p];
                                    var d = n.pop();
                                    while (p > 1) {
                                        var m = n.pop(),
                                            x = d && d.lineStart;
                                        l = this.startNode(m, x), c = u[p - 1];
                                        t = this.finalize(l, new a.BinaryExpression(c, u[p - 2], t)), p -= 2, d = m
                                    }
                                }
                                return t
                                ...
                                if (this.match("?")) {
                                    ...
                                    t = this.finalize(this.startNode(e), new a.ConditionalExpression(t, s, n)), this.context.isAssignmentTarget = !1, this.context.isBindingElement = !1
                                }
                                return t
                                ...
                                for (var n = 0; n < i.length; ++n) {
                                    var a = i[n];
                                    a.type === u.Syntax.AssignmentPattern ? a.right.type === u.Syntax.YieldExpression && (a.right.argument && this.throwUnexpectedToken(this.lookahead), a.right.type = u.Syntax.Identifier, a.right.name = "yield", delete a.right.argument, delete a.right.delegate) : s && a.type === u.Syntax.Identifier && "await" === a.name && this.throwUnexpectedToken(this.lookahead), this.checkPatternParam(t, a), i[n] = a
                                }
                                if (this.context.strict || !this.context.allowYield)
                                    for (n = 0; n < i.length; ++n) {
                                        a = i[n];
                                        a.type === u.Syntax.YieldExpression && this.throwUnexpectedToken(this.lookahead)
                                    }
                                ...
                                if (!this.context.allowYield && this.matchKeyword("yield")) e = this.parseYieldExpression();
                                    ...
                                    if (e = this.parseConditionalExpression(), 3 === i.type && i.lineNumber === this.lookahead.lineNumber && "async" === i.value && (3 === this.lookahead.type || this.matchKeyword("yield"))) {
                                        ...
                                        this.reinterpretExpressionAsPattern(s), e = {
                                            type: c,
                                            params: [s],
                                            async: !0
                                        }
                                    ...
                                    if (e.type === c || this.match("=>")) {
                                        ...
                                        if (o) {
                                            ...
                                            this.context.allowYield = !0, this.context.await = n;
                                            var m = this.startNode(t);
                                            this.expect("=>");
                                            var x = void 0;
                                            if (this.match("{")) {
                                                var D = this.context.allowIn;
                                                this.context.allowIn = !0, x = this.parseFunctionSourceElements(), this.context.allowIn = D
                                            } else x = this.isolateCoverGrammar(this.parseAssignmentExpression);
                                            var f = x.type !== u.Syntax.BlockStatement;
                                            this.context.strict && o.firstRestricted && this.throwUnexpectedToken(o.firstRestricted, o.message), this.context.strict && o.stricted && this.tolerateUnexpectedToken(o.stricted, o.message), e = n ? this.finalize(m, new a.AsyncArrowFunctionExpression(o.params, x, f)) : this.finalize(m, new a.ArrowFunctionExpression(o.params, x, f)), this.context.strict = h, this.context.allowStrictDirective = l, this.context.allowYield = p, this.context.await = d
                                        }
                                    } else if (this.matchAssign()) {
                                        if (this.context.isAssignmentTarget || this.tolerateError(r.Messages.InvalidLHSInAssignment), this.context.strict && e.type === u.Syntax.Identifier) {
                                            var E = e;
                                            this.scanner.isRestrictedWord(E.name) && this.tolerateUnexpectedToken(i, r.Messages.StrictLHSAssignment), this.scanner.isStrictModeReservedWord(E.name) && this.tolerateUnexpectedToken(i, r.Messages.StrictReservedWord)
                                        }
                                        this.match("=") ? this.reinterpretExpressionAsPattern(e) : (this.context.isAssignmentTarget = !1, this.context.isBindingElement = !1), i = this.nextToken();
                                        var y = i.value,
                                            C = this.isolateCoverGrammar(this.parseAssignmentExpression);
                                        e = this.finalize(this.startNode(t), new a.AssignmentExpression(y, e, C)), this.context.firstCoverInitializedNameError = null
                                    }
                                }
                                return e
                                ...
                                if (this.match(",")) {
                                    ...
                                    while (2 !== this.lookahead.type) {
                                        if (!this.match(",")) break;
                                        this.nextToken(), i.push(this.isolateCoverGrammar(this.parseAssignmentExpression))
                                    }
                                ...
                                var i = this.createNode(),
                                    s = [],
                                    n = this.parsePattern(s, e);
                                this.context.strict && n.type === u.Syntax.Identifier && this.scanner.isRestrictedWord(n.name) && this.tolerateError(r.Messages.StrictVarName);
                                var o = null;
                                return "const" === e ? this.matchKeyword("in") || this.matchContextualKeyword("of") || (this.match("=") ? (this.nextToken(), o = this.isolateCoverGrammar(this.parseAssignmentExpression)) : this.throwError(r.Messages.DeclarationMissingInitializer, "const")) : (!t.inFor && n.type !== u.Syntax.Identifier || this.match("=")) && (this.expect("="), o = this.isolateCoverGrammar(this.parseAssignmentExpression)), this.finalize(i, new a.VariableDeclarator(n, o))
                            }, e.prototype.parseBindingList = function(e, t) {
                                var i = [this.parseLexicalBinding(e, t)];
                                while (this.match(",")) this.nextToken(), i.push(this.parseLexicalBinding(e, t));
                                return i
                                ...
                                return this.consumeSemicolon(), this.finalize(t, new a.VariableDeclaration(n, i))
                                ...
                                var s = [];
                                while (!this.match("]"))
                                    if (this.match(",")) this.nextToken(), s.push(null);
                                    else {
                                        if (this.match("...")) {
                                            s.push(this.parseBindingRestElement(e, t));
                                            break
                                        }
                                        s.push(this.parsePatternWithDefault(e, t)), this.match("]") || this.expect(",")
                                    }
                                return this.expect("]"), this.finalize(i, new a.ArrayPattern(s))
                            }, e.prototype.parsePropertyPattern = function(e, t) {
                                var i, s, n = this.createNode(),
                                    r = !1,
                                    o = !1,
                                    u = !1;
                                if (3 === this.lookahead.type) {
                                    ...
                                    var c = this.finalize(n, new a.Identifier(h.value));
                                    if (this.match("=")) {
                                        e.push(h), o = !0, this.nextToken();
                                        var l = this.parseAssignmentExpression();
                                        s = this.finalize(this.startNode(h), new a.AssignmentPattern(c, l))
                                    } else this.match(":") ? (this.expect(":"), s = this.parsePatternWithDefault(e, t)) : (e.push(h), o = !0, s = c)
                                } else r = this.match("["), i = this.parseObjectPropertyKey(), this.expect(":"), s = this.parsePatternWithDefault(e, t);
                                return this.finalize(n, new a.Property("init", i, r, s, u, o))
                            }, e.prototype.parseObjectPattern = function(e, t) {
                                var i = this.createNode(),
                                    s = [];
                                this.expect("{");
                                while (!this.match("}")) s.push(this.parsePropertyPattern(e, t)), this.match("}") || this.expect(",");
                                return this.expect("}"), this.finalize(i, new a.ObjectPattern(s))
                                ...
                                if (this.match("=")) {
                                    ...
                                    this.context.allowYield = n, s = this.finalize(this.startNode(i), new a.AssignmentPattern(s, r))
                                }
                                return s
                                ...
                                var t = this.createNode(),
                                    i = [],
                                    s = this.parsePattern(i, "var");
                                this.context.strict && s.type === u.Syntax.Identifier && this.scanner.isRestrictedWord(s.name) && this.tolerateError(r.Messages.StrictVarName);
                                var n = null;
                                return this.match("=") ? (this.nextToken(), n = this.isolateCoverGrammar(this.parseAssignmentExpression)) : s.type === u.Syntax.Identifier || e.inFor || this.expect("="), this.finalize(t, new a.VariableDeclarator(s, n))
                                ...
                                while (this.match(",")) this.nextToken(), i.push(this.parseVariableDeclaration(t));
                                return i
                                ...
                                return !this.match(")") && this.config.tolerant ? (this.tolerateUnexpectedToken(this.nextToken()), e = this.finalize(this.createNode(), new a.EmptyStatement)) : (this.expect(")"), e = this.parseIfClause(), this.matchKeyword("else") && (this.nextToken(), i = this.parseIfClause())), this.finalize(t, new a.IfStatement(s, e, i))
                                ...
                                var s = this.parseExpression();
                                return !this.match(")") && this.config.tolerant ? this.tolerateUnexpectedToken(this.nextToken()) : (this.expect(")"), this.match(";") && this.nextToken()), this.finalize(e, new a.DoWhileStatement(i, s))
                                ...
                                if (!this.match(")") && this.config.tolerant) this.tolerateUnexpectedToken(this.nextToken()), e = this.finalize(this.createNode(), new a.EmptyStatement);
                                    ...
                                    this.context.inIteration = !0, e = this.parseStatement(), this.context.inIteration = s
                                }
                                ...
                                if (this.expectKeyword("for"), this.expect("("), this.match(";")) this.nextToken();
                                    ...
                                    if (this.context.allowIn = l, 1 === p.length && this.matchKeyword("in")) {
                                        var d = p[0];
                                        d.init && (d.id.type === u.Syntax.ArrayPattern || d.id.type === u.Syntax.ObjectPattern || this.context.strict) && this.tolerateError(r.Messages.ForInOfLoopInitializer, "for-in"), s = this.finalize(s, new a.VariableDeclaration(p, "var")), this.nextToken(), e = s, t = this.parseExpression(), s = null
                                    } else 1 === p.length && null === p[0].init && this.matchContextualKeyword("of") ? (s = this.finalize(s, new a.VariableDeclaration(p, "var")), this.nextToken(), e = s, t = this.parseAssignmentExpression(), s = null, h = !1) : (s = this.finalize(s, new a.VariableDeclaration(p, "var")), this.expect(";"))
                                    ...
                                    if (this.context.strict || "in" !== this.lookahead.value) {
                                        ...
                                        this.context.allowIn = l, 1 === p.length && null === p[0].init && this.matchKeyword("in") ? (s = this.finalize(s, new a.VariableDeclaration(p, m)), this.nextToken(), e = s, t = this.parseExpression(), s = null) : 1 === p.length && null === p[0].init && this.matchContextualKeyword("of") ? (s = this.finalize(s, new a.VariableDeclaration(p, m)), this.nextToken(), e = s, t = this.parseAssignmentExpression(), s = null, h = !1) : (this.consumeSemicolon(), s = this.finalize(s, new a.VariableDeclaration(p, m)))
                                    } else s = this.finalize(s, new a.Identifier(m)), this.nextToken(), e = s, t = this.parseExpression(), s = null
                                } else {
                                    var x = this.lookahead;
                                    l = this.context.allowIn;
                                    if (this.context.allowIn = !1, s = this.inheritCoverGrammar(this.parseAssignmentExpression), this.context.allowIn = l, this.matchKeyword("in")) this.context.isAssignmentTarget && s.type !== u.Syntax.AssignmentExpression || this.tolerateError(r.Messages.InvalidLHSInForIn), this.nextToken(), this.reinterpretExpressionAsPattern(s), e = s, t = this.parseExpression(), s = null;
                                    else if (this.matchContextualKeyword("of")) this.context.isAssignmentTarget && s.type !== u.Syntax.AssignmentExpression || this.tolerateError(r.Messages.InvalidLHSInForLoop), this.nextToken(), this.reinterpretExpressionAsPattern(s), e = s, t = this.parseAssignmentExpression(), s = null, h = !1;
                                    else {
                                        if (this.match(",")) {
                                            var D = [s];
                                            while (this.match(",")) this.nextToken(), D.push(this.isolateCoverGrammar(this.parseAssignmentExpression));
                                            s = this.finalize(this.startNode(x), new a.SequenceExpression(D))
                                        }
                                        this.expect(";")
                                    }
                                }
                                if ("undefined" === typeof e && (this.match(";") || (n = this.parseExpression()), this.expect(";"), this.match(")") || (o = this.parseExpression())), !this.match(")") && this.config.tolerant) this.tolerateUnexpectedToken(this.nextToken()), i = this.finalize(this.createNode(), new a.EmptyStatement);
                                else {
                                    this.expect(")");
                                    var f = this.context.inIteration;
                                    this.context.inIteration = !0, i = this.isolateCoverGrammar(this.parseStatement), this.context.inIteration = f
                                }
                                return "undefined" === typeof e ? this.finalize(c, new a.ForStatement(s, n, o, i)) : h ? this.finalize(c, new a.ForInStatement(e, t, i)) : this.finalize(c, new a.ForOfStatement(e, t, i))
                                ...
                                if (3 === this.lookahead.type && !this.hasLineTerminator) {
                                    ...
                                    t = i;
                                    var s = "$" + i.name;
                                    Object.prototype.hasOwnProperty.call(this.context.labelSet, s) || this.throwError(r.Messages.UnknownLabel, i.name)
                                }
                                return this.consumeSemicolon(), null !== t || this.context.inIteration || this.throwError(r.Messages.IllegalContinue), this.finalize(e, new a.ContinueStatement(t))
                                ...
                                if (3 === this.lookahead.type && !this.hasLineTerminator) {
                                    var i = this.parseVariableIdentifier(),
                                        s = "$" + i.name;
                                    Object.prototype.hasOwnProperty.call(this.context.labelSet, s) || this.throwError(r.Messages.UnknownLabel, i.name), t = i
                                }
                                return this.consumeSemicolon(), null !== t || this.context.inIteration || this.context.inSwitch || this.throwError(r.Messages.IllegalBreak), this.finalize(e, new a.BreakStatement(t))
                                ...
                                var t = !this.match(";") && !this.match("}") && !this.hasLineTerminator && 2 !== this.lookahead.type || 8 === this.lookahead.type || 10 === this.lookahead.type,
                                    i = t ? this.parseExpression() : null;
                                return this.consumeSemicolon(), this.finalize(e, new a.ReturnStatement(i))
                                ...
                                while (1) {
                                    ...
                                    null === o.test && (n && this.throwError(r.Messages.MultipleDefaultsInSwitch), n = !0), s.push(o)
                                }
                                return this.expect("}"), this.context.inSwitch = i, this.finalize(e, new a.SwitchStatement(t, s))
                                ...
                                if (i.type === u.Syntax.Identifier && this.match(":")) {
                                    ...
                                    var s = i,
                                        n = "$" + s.name;
                                    Object.prototype.hasOwnProperty.call(this.context.labelSet, n) && this.throwError(r.Messages.Redeclaration, "Label", s.name), this.context.labelSet[n] = !0;
                                    var o = void 0;
                                    if (this.matchKeyword("class")) this.tolerateUnexpectedToken(this.lookahead), o = this.parseClassDeclaration();
                                        ...
                                        this.context.strict ? this.tolerateUnexpectedToken(h, r.Messages.StrictFunction) : c.generator && this.tolerateUnexpectedToken(h, r.Messages.GeneratorInLegacyContext), o = c
                                    } else o = this.parseStatement();
                                    delete this.context.labelSet[n], e = new a.LabeledStatement(s, o)
                                ...
                                for (var t = [], i = this.parsePattern(t), s = {}, n = 0; n < t.length; n++) {
                                    var o = "$" + t[n].value;
                                    Object.prototype.hasOwnProperty.call(s, o) && this.tolerateError(r.Messages.DuplicateBinding, t[n].value), s[o] = !0
                                }
                                this.context.strict && i.type === u.Syntax.Identifier && this.scanner.isRestrictedWord(i.name) && this.tolerateError(r.Messages.StrictCatchVariable), this.expect(")");
                                ...
                                return i || s || this.throwError(r.Messages.NoCatchOrFinally), this.finalize(e, new a.TryStatement(t, i, s))
                                ...
                                this.context.labelSet = {}, this.context.inIteration = !1, this.context.inSwitch = !1, this.context.inFunctionBody = !0;
                                while (2 !== this.lookahead.type) {
                                    if (this.match("}")) break;
                                    t.push(this.parseStatementListItem())
                                }
                                return this.expect("}"), this.context.labelSet = i, this.context.inIteration = s, this.context.inSwitch = n, this.context.inFunctionBody = r, this.finalize(e, new a.BlockStatement(t))
                            }, e.prototype.validateParam = function(e, t, i) {
                                var s = "$" + i;
                                this.context.strict ? (this.scanner.isRestrictedWord(i) && (e.stricted = t, e.message = r.Messages.StrictParamName), Object.prototype.hasOwnProperty.call(e.paramSet, s) && (e.stricted = t, e.message = r.Messages.StrictParamDupe)) : e.firstRestricted || (this.scanner.isRestrictedWord(i) ? (e.firstRestricted = t, e.message = r.Messages.StrictParamName) : this.scanner.isStrictModeReservedWord(i) ? (e.firstRestricted = t, e.message = r.Messages.StrictReservedWord) : Object.prototype.hasOwnProperty.call(e.paramSet, s) && (e.stricted = t, e.message = r.Messages.StrictParamDupe)), "function" === typeof Object.defineProperty ? Object.defineProperty(e.paramSet, s, {
                                    value: !0,
                                    enumerable: !0,
                                    writable: !0,
                                    configurable: !0
                                ...
                                return this.match("=") && this.throwError(r.Messages.DefaultRestParameter), this.match(")") || this.throwError(r.Messages.ParameterAfterRestParameter), this.finalize(t, new a.RestElement(i))
                            }, e.prototype.parseFormalParameter = function(e) {
                                for (var t = [], i = this.match("...") ? this.parseRestElement(t) : this.parsePatternWithDefault(t), s = 0; s < t.length; s++) this.validateParam(e, t[s], t[s].value);
                                ...
                                if (t = {
                                    ...
                                    t.paramSet = {};
                                    while (2 !== this.lookahead.type) {
                                        if (this.parseFormalParameter(t), this.match(")")) break;
                                        if (this.expect(","), this.match(")")) break
                                    }
                                }
                                return this.expect(")"), {
                                    simple: t.simple,
                                ...
                                var s, n = !i && this.match("*");
                                n && this.nextToken();
                                var o = null,
                                    u = null;
                                if (!e || !this.match("(")) {
                                    var h = this.lookahead;
                                    o = this.parseVariableIdentifier(), this.context.strict ? this.scanner.isRestrictedWord(h.value) && this.tolerateUnexpectedToken(h, r.Messages.StrictFunctionName) : this.scanner.isRestrictedWord(h.value) ? (u = h, s = r.Messages.StrictFunctionName) : this.scanner.isStrictModeReservedWord(h.value) && (u = h, s = r.Messages.StrictReservedWord)
                                }
                                var c = this.context.await,
                                    l = this.context.allowYield;
                                this.context.await = i, this.context.allowYield = !n;
                                var p = this.parseFormalParameters(u),
                                    d = p.params,
                                    m = p.stricted;
                                u = p.firstRestricted, p.message && (s = p.message);
                                ...
                                return this.context.strict && u && this.throwUnexpectedToken(u, s), this.context.strict && m && this.tolerateUnexpectedToken(m, s), this.context.strict = x, this.context.allowStrictDirective = D, this.context.await = c, this.context.allowYield = l, i ? this.finalize(t, new a.AsyncFunctionDeclaration(o, d, f)) : this.finalize(t, new a.FunctionDeclaration(o, d, f, n))
                                ...
                                if (this.context.await = t, this.context.allowYield = !s, !this.match("(")) {
                                    var c = this.lookahead;
                                    o = this.context.strict || s || !this.matchKeyword("yield") ? this.parseVariableIdentifier() : this.parseIdentifierName(), this.context.strict ? this.scanner.isRestrictedWord(c.value) && this.tolerateUnexpectedToken(c, r.Messages.StrictFunctionName) : this.scanner.isRestrictedWord(c.value) ? (n = c, i = r.Messages.StrictFunctionName) : this.scanner.isStrictModeReservedWord(c.value) && (n = c, i = r.Messages.StrictReservedWord)
                                }
                                var l = this.parseFormalParameters(n),
                                    p = l.params,
                                    d = l.stricted;
                                n = l.firstRestricted, l.message && (i = l.message);
                                ...
                                return this.context.strict && n && this.throwUnexpectedToken(n, i), this.context.strict && d && this.tolerateUnexpectedToken(d, i), this.context.strict = m, this.context.allowStrictDirective = x, this.context.await = u, this.context.allowYield = h, t ? this.finalize(e, new a.AsyncFunctionExpression(o, p, D)) : this.finalize(e, new a.FunctionExpression(o, p, D, s))
                            }, e.prototype.parseDirective = function() {
                                var e = this.lookahead,
                                    t = this.createNode(),
                                    i = this.parseExpression(),
                                    s = i.type === u.Syntax.Literal ? this.getTokenRaw(e).slice(1, -1) : null;
                                return this.consumeSemicolon(), this.finalize(t, s ? new a.Directive(i, s) : new a.ExpressionStatement(i))
                                ...
                                while (1) {
                                    ...
                                    "use strict" === n ? (this.context.strict = !0, e && this.tolerateUnexpectedToken(e, r.Messages.StrictOctalLiteral), this.context.allowStrictDirective || this.tolerateUnexpectedToken(i, r.Messages.IllegalLanguageModeDirective)) : !e && i.octal && (e = i)
                                }
                                return t
                                ...
                                var s = this.parseFormalParameters();
                                s.params.length > 0 && this.tolerateError(r.Messages.BadGetterArity);
                                var n = this.parsePropertyMethod(s);
                                return this.context.allowYield = i, this.finalize(e, new a.FunctionExpression(null, s.params, n, t))
                                ...
                                this.context.allowYield = !t;
                                var s = this.parseFormalParameters();
                                1 !== s.params.length ? this.tolerateError(r.Messages.BadSetterArity) : s.params[0] instanceof a.RestElement && this.tolerateError(r.Messages.BadSetterRestParameter);
                                var n = this.parsePropertyMethod(s);
                                return this.context.allowYield = i, this.finalize(e, new a.FunctionExpression(null, s.params, n, t))
                                ...
                                if (!this.hasLineTerminator) {
                                    ...
                                    this.context.allowYield = !1, i = this.match("*"), i ? (this.nextToken(), t = this.parseAssignmentExpression()) : this.isStartOfExpression() && (t = this.parseAssignmentExpression()), this.context.allowYield = s
                                }
                                ...
                                if (this.match("*")) this.nextToken();
                                    ...
                                    var p = n;
                                    if ("static" === p.name && (this.qualifiedPropertyName(this.lookahead) || this.match("*")) && (t = this.lookahead, c = !0, u = this.match("["), this.match("*") ? this.nextToken() : n = this.parseObjectPropertyKey()), 3 === t.type && !this.hasLineTerminator && "async" === t.value) {
                                        var d = this.lookahead.value;
                                        ":" !== d && "(" !== d && "*" !== d && (l = !0, t = this.lookahead, n = this.parseObjectPropertyKey(), 3 === t.type && "constructor" === t.value && this.tolerateUnexpectedToken(t, r.Messages.ConstructorIsAsync))
                                    }
                                }
                                var m = this.qualifiedPropertyName(this.lookahead);
                                return 3 === t.type ? "get" === t.value && m ? (s = "get", u = this.match("["), n = this.parseObjectPropertyKey(), this.context.allowYield = !1, o = this.parseGetterMethod()) : "set" === t.value && m && (s = "set", u = this.match("["), n = this.parseObjectPropertyKey(), o = this.parseSetterMethod()) : 7 === t.type && "*" === t.value && m && (s = "init", u = this.match("["), n = this.parseObjectPropertyKey(), o = this.parseGeneratorMethod(), h = !0), !s && n && this.match("(") && (s = "init", o = l ? this.parsePropertyMethodAsyncFunction() : this.parsePropertyMethodFunction(), h = !0), s || this.throwUnexpectedToken(this.lookahead), "init" === s && (s = "method"), u || (c && this.isPropertyKey(n, "prototype") && this.throwUnexpectedToken(t, r.Messages.StaticPrototype), !c && this.isPropertyKey(n, "constructor") && (("method" !== s || !h || o && o.generator) && this.throwUnexpectedToken(t, r.Messages.ConstructorSpecialMethod), e.value ? this.throwUnexpectedToken(t, r.Messages.DuplicateConstructor) : e.value = !0, s = "constructor")), this.finalize(i, new a.MethodDefinition(n, u, o, s, c))
                                ...
                                this.expect("{");
                                while (!this.match("}")) this.match(";") ? this.nextToken() : e.push(this.parseClassElement(t));
                                return this.expect("}"), e
                                ...
                                return this.context.strict = i, this.finalize(t, new a.ClassDeclaration(s, n, r))
                                ...
                                return this.context.strict = t, this.finalize(e, new a.ClassExpression(i, s, n))
                                ...
                                while (2 !== this.lookahead.type) t.push(this.parseStatementListItem());
                                ...
                                return 3 === this.lookahead.type ? (e = this.parseVariableIdentifier(), t = e, this.matchContextualKeyword("as") && (this.nextToken(), t = this.parseVariableIdentifier())) : (e = this.parseIdentifierName(), t = e, this.matchContextualKeyword("as") ? (this.nextToken(), t = this.parseVariableIdentifier()) : this.throwUnexpectedToken(this.nextToken())), this.finalize(i, new a.ImportSpecifier(t, e))
                            }, e.prototype.parseNamedImports = function() {
                                this.expect("{");
                                var e = [];
                                while (!this.match("}")) e.push(this.parseImportSpecifier()), this.match("}") || this.expect(",");
                                return this.expect("}"), e
                                ...
                                if (8 === this.lookahead.type) e = this.parseModuleSpecifier();
                                    ...
                                    if (this.match("{") ? i = i.concat(this.parseNamedImports()) : this.match("*") ? i.push(this.parseImportNamespaceSpecifier()) : this.isIdentifierName(this.lookahead) && !this.matchKeyword("default") ? (i.push(this.parseImportDefaultSpecifier()), this.match(",") && (this.nextToken(), this.match("*") ? i.push(this.parseImportNamespaceSpecifier()) : this.match("{") ? i = i.concat(this.parseNamedImports()) : this.throwUnexpectedToken(this.lookahead))) : this.throwUnexpectedToken(this.nextToken()), !this.matchContextualKeyword("from")) {
                                        var s = this.lookahead.value ? r.Messages.UnexpectedToken : r.Messages.MissingFromClause;
                                ...
                                if (this.expectKeyword("export"), this.matchKeyword("default"))
                                    ...
                                    this.matchContextualKeyword("from") && this.throwError(r.Messages.UnexpectedToken, this.lookahead.value);
                                    ...
                                    this.consumeSemicolon(), e = this.finalize(t, new a.ExportAllDeclaration(n))
                                    ...
                                    var o = [],
                                        ...
                                        h = !1;
                                    this.expect("{");
                                    while (!this.match("}")) h = h || this.matchKeyword("default"), o.push(this.parseExportSpecifier()), this.match("}") || this.expect(",");
                                    if (this.expect("}"), this.matchContextualKeyword("from")) this.nextToken(), u = this.parseModuleSpecifier(), this.consumeSemicolon();
                                    else if (h) {
                                        s = this.lookahead.value ? r.Messages.UnexpectedToken : r.Messages.MissingFromClause;
                                        this.throwError(s, this.lookahead.value)
                    ...
                    var i = function() {
                        ...
                        return e.prototype.recordError = function(e) {
                            ...
                            try {
                                ...
                                Object.create && Object.defineProperty && (i = Object.create(s), Object.defineProperty(i, "column", {
                                    value: t
                                }))
                            }
                            return i
                    ...
                    var u = function() {
                        ...
                        return e.prototype.saveState = function() {
                            ...
                            var t, i, s = [];
                            this.trackComment && (s = [], t = this.index - e, i = {
                                start: {
                            ...
                            while (!this.eof()) {
                                ...
                                if (++this.index, n.Character.isLineTerminator(r)) {
                                    ...
                                    return 13 === r && 10 === this.source.charCodeAt(this.index) && ++this.index, ++this.lineNumber, this.lineStart = this.index, s
                                }
                            }
                            if (this.trackComment) {
                                i.end = {
                            ...
                            var e, t, i = [];
                            this.trackComment && (i = [], e = this.index - 2, t = {
                                start: {
                                    line: this.lineNumber,
                            ...
                            while (!this.eof()) {
                                ...
                                if (n.Character.isLineTerminator(s)) 13 === s && 10 === this.source.charCodeAt(this.index + 1) && ++this.index, ++this.lineNumber, ++this.index, this.lineStart = this.index;
                                else if (42 === s) {
                            ...
                            while (!this.eof()) {
                                ...
                                else if (n.Character.isLineTerminator(i)) ++this.index, 13 === i && 10 === this.source.charCodeAt(this.index) && ++this.index, ++this.lineNumber, this.lineStart = this.index, t = !0;
                                else if (47 === i)
                            ...
                            if (t >= 55296 && t <= 56319) {
                                ...
                                if (i >= 56320 && i <= 57343) {
                                    var s = t;
                                    t = 1024 * (s - 55296) + i - 56320 + 65536
                                }
                            }
                            return t
                        }, e.prototype.scanHexEscape = function(e) {
                            for (var t = "u" === e ? 4 : 2, i = 0, s = 0; s < t; ++s) {
                                if (this.eof() || !n.Character.isHexDigit(this.source.charCodeAt(this.index))) return null;
                            ...
                            while (!this.eof()) {
                                if (e = this.source[this.index++], !n.Character.isHexDigit(e.charCodeAt(0))) break;
                                t = 16 * t + a(e)
                            }
                            return (t > 1114111 || "}" !== e) && this.throwUnexpectedToken(), n.Character.fromCodePoint(t)
                            ...
                            while (!this.eof()) {
                                ...
                                if (!n.Character.isIdentifierPart(t)) break;
                                ++this.index
                            }
                            ...
                            this.index += i.length, 92 === t && (117 !== this.source.charCodeAt(this.index) && this.throwUnexpectedToken(), ++this.index, "{" === this.source[this.index] ? (++this.index, e = this.scanUnicodeCodePointEscape()) : (e = this.scanHexEscape("u"), null !== e && "\\" !== e && n.Character.isIdentifierStart(e.charCodeAt(0)) || this.throwUnexpectedToken()), i = e);
                            while (!this.eof()) {
                                if (t = this.codePointAt(this.index), !n.Character.isIdentifierPart(t)) break;
                                e = n.Character.fromCodePoint(t), i += e, this.index += e.length, 92 === t && (i = i.substr(0, i.length - 1), 117 !== this.source.charCodeAt(this.index) && this.throwUnexpectedToken(), ++this.index, "{" === this.source[this.index] ? (++this.index, e = this.scanUnicodeCodePointEscape()) : (e = this.scanHexEscape("u"), null !== e && "\\" !== e && n.Character.isIdentifierPart(e.charCodeAt(0)) || this.throwUnexpectedToken()), i += e)
                            }
                            return i
                        }, e.prototype.octalToDecimal = function(e) {
                            var t = "0" !== e,
                                i = o(e);
                            return !this.eof() && n.Character.isOctalDigit(this.source.charCodeAt(this.index)) && (t = !0, i = 8 * i + o(this.source[this.index++]), "0123".indexOf(e) >= 0 && !this.eof() && n.Character.isOctalDigit(this.source.charCodeAt(this.index)) && (i = 8 * i + o(this.source[this.index++]))), {
                                code: i,
                                octal: t
                            }
                            ...
                            if (e = 1 === i.length ? 3 : this.isKeyword(i) ? 4 : "null" === i ? 5 : "true" === i || "false" === i ? 1 : 3, 3 !== e && t + i.length !== this.index) {
                                var s = this.index;
                                this.index = t, this.tolerateUnexpectedToken(r.Messages.InvalidEscapedReservedWord), this.index = s
                            }
                            return {
                                type: e,
                                value: i,
                            ...
                            var t = "";
                            while (!this.eof()) {
                                if (!n.Character.isHexDigit(this.source.charCodeAt(this.index))) break;
                                t += this.source[this.index++]
                            }
                            return 0 === t.length && this.throwUnexpectedToken(), n.Character.isIdentifierStart(this.source.charCodeAt(this.index)) && this.throwUnexpectedToken(), {
                                type: 6,
                            ...
                            var t, i = "";
                            while (!this.eof()) {
                                if (t = this.source[this.index], "0" !== t && "1" !== t) break;
                                i += this.source[this.index++]
                            }
                            return 0 === i.length && this.throwUnexpectedToken(), this.eof() || (t = this.source.charCodeAt(this.index), (n.Character.isIdentifierStart(t) || n.Character.isDecimalDigit(t)) && this.throwUnexpectedToken()), {
                                type: 6,
                                value: parseInt(i, 2),
                                lineNumber: this.lineNumber,
                                lineStart: this.lineStart,
                            ...
                            var i = "",
                                s = !1;
                            n.Character.isOctalDigit(e.charCodeAt(0)) ? (s = !0, i = "0" + this.source[this.index++]) : ++this.index;
                            while (!this.eof()) {
                                if (!n.Character.isOctalDigit(this.source.charCodeAt(this.index))) break;
                                i += this.source[this.index++]
                            }
                            return s || 0 !== i.length || this.throwUnexpectedToken(), (n.Character.isIdentifierStart(this.source.charCodeAt(this.index)) || n.Character.isDecimalDigit(this.source.charCodeAt(this.index))) && this.throwUnexpectedToken(), {
                                type: 6,
                                value: parseInt(i, 8),
                                octal: s,
                                lineNumber: this.lineNumber,
                            ...
                            for (var e = this.index + 1; e < this.length; ++e) {
                                var t = this.source[e];
                                if ("8" === t || "9" === t) return !1;
                                if (!n.Character.isOctalDigit(t.charCodeAt(0))) return !0
                            }
                            return !0
                        }, e.prototype.scanNumericLiteral = function() {
                            var e = this.index,
                                t = this.source[e];
                            s.assert(n.Character.isDecimalDigit(t.charCodeAt(0)) || "." === t, "Numeric literal must start with a decimal digit or a decimal point");
                            var i = "";
                            if ("." !== t) {
                                if (i = this.source[this.index++], t = this.source[this.index], "0" === i) {
                                    ...
                                    if (t && n.Character.isOctalDigit(t.charCodeAt(0)) && this.isImplicitOctalLiteral()) return this.scanOctalLiteral(t, e)
                                }
                                while (n.Character.isDecimalDigit(this.source.charCodeAt(this.index))) i += this.source[this.index++];
                                t = this.source[this.index]
                            }
                            if ("." === t) {
                                i += this.source[this.index++];
                            ...
                            if ("e" === t || "E" === t)
                                if (i += this.source[this.index++], t = this.source[this.index], "+" !== t && "-" !== t || (i += this.source[this.index++]), n.Character.isDecimalDigit(this.source.charCodeAt(this.index)))
                                    while (n.Character.isDecimalDigit(this.source.charCodeAt(this.index))) i += this.source[this.index++];
                            ...
                            while (!this.eof()) {
                                ...
                                if ("\\" === o)
                                    if (o = this.source[this.index++], o && n.Character.isLineTerminator(o.charCodeAt(0))) ++this.lineNumber, "\r" === o && "\n" === this.source[this.index] && ++this.index, this.lineStart = this.index;
                                    else switch (o) {
                                        case "u":
                                        ...
                                        case "x":
                                            ...
                                            null === h && this.throwUnexpectedToken(r.Messages.InvalidHexEscapeSequence), a += h;
                                            break;
                                        case "n":
                                            a += "\n";
                                            break;
                                        ...
                                        default:
                                            if (o && n.Character.isOctalDigit(o.charCodeAt(0))) {
                                                ...
                                                i = c.octal || i, a += String.fromCharCode(c.code)
                                            } else a += o;
                                            break
                                    } else {
                                        if (n.Character.isLineTerminator(o.charCodeAt(0))) break;
                                        a += o
                                    }
                            }
                            ...
                            while (!this.eof()) {
                                ...
                                if ("$" === u) {
                                    ...
                                    if (u = this.source[this.index++], n.Character.isLineTerminator(u.charCodeAt(0))) ++this.lineNumber, "\r" === u && "\n" === this.source[this.index] && ++this.index, this.lineStart = this.index;
                                    else switch (u) {
                                        case "n":
                                            e += "\n";
                                            break;
                                        ...
                                        case "u":
                                            if ("{" === this.source[this.index]) ++this.index, e += this.scanUnicodeCodePointEscape();
                                                ...
                                                null !== c ? e += c : (this.index = h, e += u)
                                            }
                                            break;
                                        case "x":
                                            var l = this.scanHexEscape(u);
                                            null === l && this.throwUnexpectedToken(r.Messages.InvalidHexEscapeSequence), e += l;
                                            break;
                                        case "b":
                                            e += "\b";
                                            break;
                                        ...
                                        case "v":
                                            ...
                                            break;
                                        default:
                                            "0" === u ? (n.Character.isDecimalDigit(this.source.charCodeAt(this.index)) && this.throwUnexpectedToken(r.Messages.TemplateOctalLiteral), e += "\0") : n.Character.isOctalDigit(u.charCodeAt(0)) ? this.throwUnexpectedToken(r.Messages.TemplateOctalLiteral) : e += u;
                                            break
                                    } else n.Character.isLineTerminator(u.charCodeAt(0)) ? (++this.lineNumber, "\r" === u && "\n" === this.source[this.index] && ++this.index, this.lineStart = this.index, e += "\n") : e += u
                            }
                            return t || this.throwUnexpectedToken(), s || this.curlyStack.pop(), {
                                type: 10,
                            ...
                            var i = "￿",
                                s = e,
                                n = this;
                            t.indexOf("u") >= 0 && (s = s.replace(/\\u\{([0-9a-fA-F]+)\}|\\u([a-fA-F0-9]{4})/g, (function(e, t, s) {
                                var a = parseInt(t || s, 16);
                                return a > 1114111 && n.throwUnexpectedToken(r.Messages.InvalidRegExp), a <= 65535 ? String.fromCharCode(a) : i
                            })).replace(/[\uD800-\uDBFF][\uDC00-\uDFFF]/g, i));
                            try {
                                RegExp(s)
                            } catch (a) {
                            ...
                            var t = this.source[this.index++],
                                ...
                                a = !1;
                            while (!this.eof())
                                if (e = this.source[this.index++], t += e, "\\" === e) e = this.source[this.index++], n.Character.isLineTerminator(e.charCodeAt(0)) && this.throwUnexpectedToken(r.Messages.UnterminatedRegExp), t += e;
                                else if (n.Character.isLineTerminator(e.charCodeAt(0))) this.throwUnexpectedToken(r.Messages.UnterminatedRegExp);
                            else if (i) "]" === e && (i = !1);
                            else {
                                if ("/" === e) {
                                    a = !0;
                            ...
                            return a || this.throwUnexpectedToken(r.Messages.UnterminatedRegExp), t.substr(1, t.length - 2)
                        }, e.prototype.scanRegExpFlags = function() {
                            var e = "",
                                t = "";
                            while (!this.eof()) {
                                var i = this.source[this.index];
                                if (!n.Character.isIdentifierPart(i.charCodeAt(0))) break;
                                if (++this.index, "\\" !== i || this.eof()) t += i, e += i;
                                else if (i = this.source[this.index], "u" === i) {
                                    ++this.index;
                                    var s = this.index,
                                        r = this.scanHexEscape("u");
                                    if (null !== r)
                                        for (t += r, e += "\\u"; s < this.index; ++s) e += this.source[s];
                    ...
                    var s = i(10),
                                ...
                                switch (e) {
                                    ...
                                    case "}":
                                        if (t = !1, "function" === this.values[this.curly - 3]) {
                                            ...
                                            t = !!s && !this.beforeFunctionExpression(s)
                                        } else if ("function" === this.values[this.curly - 4]) {
                                            s = this.values[this.curly - 5];
                                            t = !s || !this.beforeFunctionExpression(s)
                                        }
                                        break;
                                    default:
                        ...
                        o = function() {
                            function e(e, t) {
                                this.errorHandler = new s.ErrorHandler, this.errorHandler.tolerant = !!t && ("boolean" === typeof t.tolerant && t.tolerant), this.scanner = new n.Scanner(e, this.errorHandler), this.scanner.trackComment = !!t && ("boolean" === typeof t.comment && t.comment), this.trackRange = !!t && ("boolean" === typeof t.range && t.range), this.trackLoc = !!t && ("boolean" === typeof t.loc && t.loc), this.buffer = [], this.reader = new a
                            }
                                ...
                                if (0 === this.buffer.length) {
                                    ...
                                    if (this.scanner.trackComment)
                                        for (var t = 0; t < e.length; ++t) {
                                            ...
                                            this.trackRange && (n.range = i.range), this.trackLoc && (n.loc = i.loc), this.buffer.push(n)
                                        }
                                    if (!this.scanner.eof()) {
                                        var a = void 0;
                                        this.trackLoc && (a = {
                                        ...
                                        var o = "/" === this.scanner.source[this.scanner.index] && this.reader.isRegexStart(),
                                            u = o ? this.scanner.scanRegExp() : this.scanner.lex();
                                        this.reader.push(u);
                                        var h = {
                                            type: r.TokenName[u.type],
                                            value: this.scanner.source.slice(u.start, u.end)
                                        };
                                        if (this.trackRange && (h.range = [u.start, u.end]), this.trackLoc && (a.end = {
                                                line: this.scanner.lineNumber,
                                                column: this.scanner.index - this.scanner.lineStart
                                            }, h.loc = a), 9 === u.type) {
                                            var c = u.pattern,
