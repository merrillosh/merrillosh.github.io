...
function initializeTheme() {
 ...
 function e() {
  ...
  $("#menu").on("mouseenter", i).on("mouseleave", n),
      $("#menu").on("click", function () {
          r();
      }),
      $("#overlay-navigation .navWrapper a").on("click", function () {
          o();
      }),
      $("#overlay-navigation .close-button").on("click", function () {
...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function () {
  ...
  (function (t) {
      function e() {
          t("a").each(function () {
            this.href.indexOf("/wp-admin/")===-1&&this.href.indexOf("/wp-login.php")===-1||t(this).addClass(" ")})}
            t(function(){e();var i={
                anchors:"a",
                blacklist:".wp-link",
                onStart: {
