(function(E) {
    ...
    */
    var aa = function(a) {
        ...
        q = function(a, b, c) {
            if (b) a: {
                ...
                d = d[d.length - 1];c = ea && "es6" === c ? f[d] : null;b = b(c);null != b && (a ? ba(m, d, {
                    configurable: !0,
                    writable: !0,
                    value: b
    ...
    var pa = la,
        ...
        qa = ea && "function" == typeof n(Object, "assign") ? n(Object, "assign") : function(a, b) {
        ...
        var d = function(h, k) {
                ...
                if (p && v(h.h, l))
                    for (h = 0; h < p.length; h++) {
                        var S = p[h];
                        if (k !== k && S.key !== S.key || k === S.key) return {
                            id: l,
                            list: p,
                            index: h,
                            m: S
    ...
    var La = function(a) {
            return a instanceof Ka && a.constructor === Ka && a.j === Ja ? a.h : "type_error:Const"
        },
        x = function(a) {
            return new Ka(Ia, a)
        },
    ...
    var Qa = function(a, b) {
        ...
        var c = a[3] || "";
        return new y(a[1] + Pa("?", a[2] || "", b) + Pa("#", c, void 0), Ma)
    };
    ...
    var db = RegExp('^(?:audio/(?:3gpp2|3gpp|aac|L16|midi|mp3|mp4|mpeg|oga|ogg|opus|x-m4a|x-matroska|x-wav|wav|webm)|font/\\w+|image/(?:bmp|gif|jpeg|jpg|png|tiff|webp|x-icon)|video/(?:mpeg|mp4|ogg|webm|quicktime|x-matroska))(?:;\\w+=(?:\\w+|"[\\w;,= ]+"))*$', "i"),
        eb = /^data:(.*);base64,[a-z0-9+\/]+=*$/i,
        fb = /^(?:(?:https?|mailto|ftp):|[^:/?#]*(?:[/?#]|$))/i,
        cb = {},
        gb = new z("about:invalid#zClosurez", cb);
    var hb;
    a: {
        var ib = w.navigator;
        if (ib) {
    ...
    var lb = function(a) {
        ...
        qb = function(a, b) {
            ...
            if (a)
                for (k in a)
                    if (Object.prototype.hasOwnProperty.call(a, k)) {
                        if (!nb.test(k)) throw Error("");
                        d = a[k];
                        if (null != d) {
                            c = k;
                            if (d instanceof Ka) d = La(d);
                            else {
                                if ("style" == c.toLowerCase()) throw Error("");
                                if (/^on/i.test(c)) throw Error("");
                                if (c.toLowerCase() in ob)
                                    if (d instanceof y) d = Oa(d).toString();
                                    else if (d instanceof z) d = d instanceof z && d.constructor === z ? d.j : "type_error:SafeUrl";
                                else if ("string" === typeof d) d instanceof z || (d = "object" == typeof d && d.A ? d.g() : String(d), fb.test(d) ? d = new z(d, cb) : (d = String(d), d = d.replace(/(%0A|%0D)/g, ""), d = (e = d.match(eb)) && db.test(e[1]) ? new z(d, cb) : null)), d = (d || gb).g();
                                else throw Error("");
                            }
                            d.A && (d = d.g());
                            c = c + '="' + $a(String(d)) + '"';
            ...
            !0 === Ha.script ? k += ">" : (h = pb(h), k += ">" + lb(h).toString() + "\x3c/script>", b = h.h());
        ...
        sb = function(a) {
            var b = mb(rb),
                ...
                d = [],
                e = function(f) {
                    Array.isArray(f) ? f.forEach(e) : (f = mb(f), d.push(lb(f).toString()), f = f.h(), 0 == c ? c = f : 0 != f && c != f && (c = null))
                };
            a.forEach(e);
            return new B(d.join(lb(b).toString()), c, kb)
        },
        pb = function(a) {
            return sb(Array.prototype.slice.call(arguments))
        },
        nb = /^[a-zA-Z0-9-]+$/,
        ob = {
            action: !0,
        ...
        rb = new B(w.trustedTypes && w.trustedTypes.emptyHTML || "", 0, kb);
    var tb = function(a, b) {
            a.write(lb(b))
        },
        vb = function() {
            a: {
                var a = w.document;
                if (a.querySelector && (a = a.querySelector("script[nonce]")) && (a = a.nonce || a.getAttribute("nonce")) && ub.test(a)) break a;a = ""
            }
            return a
        },
        ub = /^[\w+/_-]+[=]{0,2}$/;
    ...
    function Db(a, b, c) {
        return "object" === typeof a ? Cb && !Array.isArray(a) && a instanceof Uint8Array ? c(a) : Eb(a, b, c) : b(a)
    }
    ...
    function Eb(a, b, c) {
        if (Array.isArray(a)) {
            ...
            Array.isArray(a) && a.da && Fb(d);
            return d
        }
        d = {};
        for (e in a) Object.prototype.hasOwnProperty.call(a, e) && (f = a[e], null != f && (d[e] = Db(f, b, c)));
        return d
    }
    ...
    var C = function(a, b, c) {
            ...
            a: {
                ...
                if (d && (d = this.h[a], !(null === d || "object" != typeof d || Array.isArray(d) || Cb && d instanceof Uint8Array))) {
                    this.l = a - this.j;
                    this.i = d;
                    break a
                }
            ...
            if (c)
                for (b = 0; b < c.length; b++) a = c[b], a < this.l ? (a += this.j, (d = this.h[a]) ? Fb(d) : this.h[a] = Kb) : (Lb(this), (d = this.i[a]) ? Fb(d) : this.i[a] = Kb)
        },
        Kb = Object.freeze(Fb([])),
        Lb = function(a) {
            var b = a.l + a.j;
        ...
        F = function(a, b, c, d) {
            (void 0 === d ? 0 : d) || b >= a.l ? (Lb(a), a.i[b] = c) : a.h[b + a.j] = c;
            return a
        };

    function Ob(a, b, c) {
        0 !== c ? F(a, b, c) : F(a, b, void 0);
        return a
    }
    var Pb = function(a, b, c, d) {
            (c = H(a, c)) && c !== b && null != d && (a.g && c in a.g && (a.g[c] = void 0), F(a, c, void 0));
            return F(a, b, d)
        },
        H = function(a, b) {
            for (var c = 0, d = 0; d < b.length; d++) {
                var e = b[d];
                null != D(a, e) && (0 !== c && F(a, c, void 0), c = e)
            }
            return c
        },
        I = function(a, b, c) {
        ...
        Sb = function(a, b, c) {
            ...
            a.g || (a.g = {});
            c = c || [];
            for (var e = Fb([]), f = 0; f < c.length; f++) e[f] = Qb(c[f], !1);
            a.g[b] = c;
            return F(a, b, e, d)
        };
    ...
    var Qb = function(a, b) {
            if (a.g)
                for (var c in a.g)
                    if (Object.prototype.hasOwnProperty.call(a.g, c)) {
                        var d = a.g[c];
                        if (Array.isArray(d))
                            for (var e = 0; e < d.length; e++) d[e] && Qb(d[e], b);
                        else d && Qb(d, b)
                    }
            return a.h
        },
        ...
        Tb = function(a, b) {
            switch (typeof b) {
                ...
                case "object":
                    if (Cb && null != b && b instanceof Uint8Array) return zb(b)
            }
            return b
        },
        Vb = function(a, b, c) {
            return G(a, b, void 0 === c ? "" : c)
        },
        Wb = function(a, b, c) {
            b = H(a, c) === b ? b : -1;
            return G(a, b, 0)
    ...
    */
    ...
    var pc = function(a, b) {
            if (!mc() && !nc()) {
                var c = Math.random();
                if (c < b) return c = oc(w), a[Math.floor(c * a.length)]
            }
            return null
        },
        oc = function(a) {
        ...
        tc = /^(-?[0-9.]{1,30})$/,
        uc = function(a, b) {
            return tc.test(a) && (a = Number(a), !isNaN(a)) ? a : void 0 == b ? null : b
        },
        vc = function(a) {
            return /^true$/.test(a)
        },
        wc = za(function() {
            return !hc() && (A("iPod") || A("iPhone") || A("Android") || A("IEMobile")) ? 2 : hc() ? 1 : 0
        }),
        xc = function(a, b) {
            a = void 0 === a ? "" : a;
            b = void 0 === b ? window : b;
            return (b = jc(b.location.href.match(ic)[3] || null)) ? rc(b + a) : null
        },
        yc = function(a, b) {
    ...
    var Fc = function(a) {
        ...
        Ic = function(a) {
            var b = K(a, 16);
            return !0 === !!K(a, 1) ? (a = Gc(a), a.forEach(function(c) {
    ...
    var Kc = function(a, b) {
            try {
                ...
                c.specialFeatureOptins = Jc(Hc(d, 12, Ec), Ec);
                c.purpose = {
                    consents: Jc(Hc(d, 24, Dc), Dc),
                    legitimateInterests: Jc(Hc(d, 24, Dc), Dc)
                };
                c.purposeOneTreatment = !!K(d, 1);
                c.publisherCC = String.fromCharCode(Cc + K(d, 6)) + String.fromCharCode(Cc + K(d, 6));
                c.vendor = {
                    consents: Jc(Ic(d), b),
                    legitimateInterests: Jc(Ic(d), b)
                };
                return c
            } catch (e) {
                return null
    ...
    nd.prototype.set = function(a, b, c) {
        var d = !1;
        if ("object" === typeof c) {
            var e = c.va;
            d = c.wa || !1;
    ...
    nd.prototype.clear = function() {
        for (var a = (this.g.cookie || "").split(";"), b = [], c = [], d, e, f = 0; f < a.length; f++) e = Sa(a[f]), d = e.indexOf("="), -1 == d ? (b.push(""), c.push(e)) : (b.push(e.substring(0, d)), c.push(e.substring(d + 1)));
    ...
    var qd = function(a) {
        ...
        sd = function(a) {
            a.__tcfapiPostMessageReady || rd(new qd(a))
        },
        rd = function(a) {
            a.h = function(b) {
    ...
    var td = function(a, b) {
        var c = a.document,
            d = a ? new gc(9 == a.nodeType ? a : a.ownerDocument || a.document) : ya || (ya = new gc),
            e = function() {
                if (!a.frames[b])
                    if (c.body) {
                        var f = fc(d.g, "IFRAME");
    ...
    var ud = function(a) {
            this.g = a;
            this.h = a.document;
            this.l = (a = (a = od(this.h)) ? I(a, md, 5) || null : null) ? D(a, 2) : null;
            this.i = (a = pd(this.h)) && null != D(a, 1) ? D(a, 1) : null;
            this.j = (a = pd(this.h)) && null != D(a, 2) ? D(a, 2) : null
        },
        xd = function(a) {
            a.__uspapi || a.frames.__uspapiLocator || (a = new ud(a), vd(a), wd(a))
        },
        vd = function(a) {
            !a.l || a.g.__uspapi || a.g.frames.__uspapiLocator || (a.g.__uspapiManager = "fc", td(a.g, "__uspapiLocator"), xa("__uspapi", function(b) {
    ...
    var wd = function(a) {
        !a.i || a.g.__tcfapi || a.g.frames.__tcfapiLocator || (a.g.__tcfapiManager = "fc", td(a.g, "__tcfapiLocator"), a.g.__tcfapiEventListeners = a.g.__tcfapiEventListeners || [], xa("__tcfapi", function(b) {
            for (var c = [], d = 0; d < arguments.length; ++d) c[d] = arguments[d];
            return a.o.apply(a, t(c))
        }), sd(a.g))
    };
    ud.prototype.o = function(a, b, c, d) {
        d = void 0 === d ? null : d;
    ...
    var Wd = Vd.aa,
        ...
        $d = function(a, b) {
            var c = J(a, Sd, 2);
            if (!c.length) return Zd(a, b);
            a = G(a, 1, 0);
            if (1 === a) return Xd($d(c[0], b));
            c = Ca(c, function(d) {
                return function() {
                    return $d(d, b)
                }
        ...
        Zd = function(a, b) {
            ...
            if (d && (b = (b = b[c]) && b[d])) {
                ...
                d = null != e;
                if (5 === b) return d;
                if (12 === b) a = Vb(a, 7 === H(a, Ud) ? 7 : -1, void 0);
                else a: {
                    switch (c) {
                        case M:
                            a = Nb(a, 6 === H(a, Ud) ? 6 : -1, void 0);
                            break a;
                        case N:
                            a = Vb(a, 7 === H(a, Ud) ? 7 : -1, void 0);
                            break a
                    }
                    a = void 0
                }
    ...
    var ee = [5],
        fe = [1, 2, 3, 6, 7];
    var P = function(a) {
        if (a.I && a.hasOwnProperty("I")) return a.I;
        var b = new a;
        return a.I = b
    };
    var Q = function() {
        var a = {};
        this.g = (a[Wd] = {}, a[M] = {}, a[N] = {}, a)
    };
    var ge = vc("false");
    var he = ge,
        ie = function(a, b) {
        ...
        me = function(a) {
            var b = P(Q).g;
            if (b) {
                var c = Ea(J(a, de, 5), function(d) {
                    return ae(I(d, Sd, 1), b)
                });
                if (c) return I(c, ce, 2)
            }
            return I(a, ce, 4)
        },
        oe = function() {
        ...
        we = function() {
            return Ca(n(Object, "keys").call(Object, P(oe).g), function(a) {
                return Number(a)
            })
        },
        xe = function(a) {
            Fa(P(oe).h, a) || te(le(4), a)
        };
    var R = function(a) {
            this.methodName = a
        },
        ...
        Pe = function(a) {
            ...
            T(Ne, function(b) {
                for (var c = P(Q), d = r([Wd, M, N]), e = d.next(); !e.done; e = d.next()) e = e.value, n(Object, "assign").call(Object, c.g[e], b[e])
            }, a)
        },
        Qe = function(a) {
    ...
    var Te = function(a, b) {
        ...
        Ue = function() {
            ...
            this[Wd] = (a[8] = function(b) {
                ...
                return Fa(P(Re).h(), parseInt(b, 10))
            }, a[27] = function(b) {
                b = Te(b, "boolean");
    ...
    var $e = [1, 4, 2, 3],
        bf = [2];
    var ef = function(a) {
            var b = void 0 === b ? new Oc(za(Lc(0 < a ? 1 / a : 0))) : b;
            this.i = a;
            this.h = b;
            this.g = []
        },
        ff = function(a, b, c, d, e) {
            b = Id(Hd(new Gd, b), c);
            d = Dd(Cd(Fd(Ed(new Bd, d), e), b), a.g);
            var f = Nd(d);
            Pc(a.h, function() {
                var g = Ob(f, 1, Date.now());
                var h = zc(window);
                g = Ob(g, 2, h);
                return Ob(g, 6, a.i)
            });
    ...
    var gf = [12, 13, 20],
        ...
        kf = function(a, b, c) {
            if (a.o[b]) return .001 >= Math.random() && Bc({
                b: c,
                dp: b
            }, "tagging_dupdiv"), !0;
            a.o[b] = !0;
        ...
        of = function(a, b, c) {
            var d = [],
                e = lf(a.i, b);
            if (9 !== b && kf(a, b, c) || !e.length) {
                var f;
                null == (f = a.l) || ff(f, b, c, d, []);
                return d
            }
            var g = Fa(gf, b),
                h = [];
            Aa(e, function(l) {
                ...
                if (l = mf(a, l, c, p)) {
                    ...
                    nf(a, p, g ? 4 : c);
                    var S = J(l, O, 2);
                    S && (g ? Aa(we(), function(gg) {
                        return ue(S, gg)
                    }) : ue(S, c))
                }
            });
            var k;
            null == (k = a.l) || ff(k, b, c, d, h);
            return d
        },
        nf = function(a, b, c) {
            a.g[c] || (a.g[c] = []);
        ...
        pf = function(a, b) {
            a.i.push.apply(a.i, t(Ba(Ca(b, function(c) {
                return new cf(c)
            }), function(c) {
                return !Fa(gf, c.B())
            })))
        ...
        mf = function(a, b, c, d) {
            ...
            if (h = G(b, 10, 0)) {
                ...
                if (void 0 === c && 1 === G(b, 11, 0)) return null;
                void 0 !== c && Ob(d, 3, c);
                return (b = qf(b, c)) ? rf(a, [b], 1) : null
            }
            d = e ? Ba(f, function(l) {
                return ae(I(l, Sd, 3), e)
            }) : f;
            return d.length ? (b = G(b, 4, 0)) ? sf(a, b, g, d) : rf(a, d, g / 1E3) : null
        },
        sf = function(a, b, c, d) {
        ...
        qf = function(a, b) {
            var c = J(a, Xe, 2),
                ...
                e = G(a, 8, 0);
            a = d * G(a, 1, 0) - 1;
            b = void 0 !== b ? b : Math.floor(1E3 * oc(window));
            d = (b - e) % d;
            if (b < e || b - e - d >= a) return null;
            c = c[d];
            e = P(Q).g;
            return !c || e && !ae(I(c, Sd, 3), e) ? null : c
        };
    var uf = function() {
            var a = {};
            this.h = function(b, c) {
        ...
        V = function(a) {
            return P(uf).h(a.g, a.defaultValue)
        },
        vf = function(a) {
            return P(uf).i(a.g, a.defaultValue)
        };
    var wf = function() {
            this.g = function() {}
        },
    ...
    var yf, zf, Cf = function(a) {
            ...
            d = void 0 === d ? Ve() : d;
            e = void 0 === e ? 0 : e;
            var f = void 0 === f ? new ef(null != (zf = null == (yf = I(a, df, 5)) ? void 0 : G(yf, 2, 0)) ? zf : 0) : f;
            d.hasOwnProperty("init-done") ? (U(Le, d)(Ca(J(a, cf, 2), function(g) {
                return g.toJSON()
            })), U(Me, d)(Ca(J(a, O, 1), function(g) {
                return g.toJSON()
            }), e), b && U(Ne, d)(b), Bf(d, e)) : (tf(jf(P(hf), J(a, cf, 2), e, c, f), d), Oe(d), Pe(d), Qe(d), Bf(d, e), ue(J(a, O, 1), e), he = he || !(!c || !c.ua), xf(P(Ue)), b && xf(b))
        },
        Bf = function(a, b) {
            a = void 0 === a ? Ve() : a;
            b = void 0 === b ? 0 : b;
    ...
    var Ef = P(uf).g(Tc.g, Tc.defaultValue);
    ...
    var Hf = w.performance,
        If = !!(Hf && Hf.mark && Hf.measure && Hf.clearMarks),
        Jf = za(function() {
            var a;
            if (a = If) a = Qd(), a = !!a.indexOf && 0 <= a.indexOf("1337");
            return a
        });
    var Kf = ia(["https://pagead2.googlesyndication.com/pagead/js/err_rep.js"]),
        Lf = function(a, b, c) {
    ...
    Lf.prototype.l = function(a, b, c, d, e) {
        c = void 0 === c ? this.i : c;
        e = void 0 === e ? this.j : e;
        if (Math.random() > c) return !1;
        b.error && b.meta && b.id || (b = new Od(b, {
            context: a,
            id: e
        }));
        ...
        if (!w.error_rep_loaded) {
            ...
            var f;
            a = w.document;
            b = null != (f = this.s) ? f : new y(dc(c).toString(), Ma);
    ...
    var Nf = function(a, b) {
        try {
            ...
            if (a.g && c && (b = c) && Hf && Jf() && (Hf.clearMarks("goog_" + b.label + "_" + b.uniqueId + "_start"), Hf.clearMarks("goog_" + b.label + "_" + b.uniqueId + "_end")), !a.o(420, d, a.i, void 0, a.j)) throw d;
        }
    };
    var Of = P(uf).g(Uc.g, Uc.defaultValue);

    function Pf(a) {
        a = void 0 === a ? window.document : a;
        yc(Of, a)
    };
    var Qf = x("gpt/pubads_impl_"),
        Rf = x("https://securepubads.g.doubleclick.net/");
    var Sf = function(a, b) {
            var c = Gf(b);
            c && (a = {
                label: a,
    ...
    function Yf(a) {
        a = a.id;
        return null != a && (Xf().has(a) || n(a, "startsWith").call(a, "google_ads_iframe_") || n(a, "startsWith").call(a, "aswift"))
    }
    ...
    var ig = function() {
            var a = new eg;
            if (V(Vc) && !window.google_plmetrics && window.PerformanceObserver) {
                window.google_plmetrics = !0;
                for (var b = r(["layout-shift", "largest-contentful-paint", "first-input", "longtask"]), c = b.next(); !c.done; c = b.next()) c = c.value, fg(a).observe({
                    type: c,
                    buffered: !V(Zc)
                });
                hg(a)
        ...
        fg = function(a) {
            a.l || (a.l = new PerformanceObserver(Uf(640, function(b) {
                var c = jg !== window.scrollX || kg !== window.scrollY ? [] : lg,
                    d = mg();
                b = r(b.getEntries());
                for (var e = b.next(); !e.done; e = b.next()) switch (e = e.value, e.entryType) {
                    case "layout-shift":
                        var f = a;
                        if (!e.hadRecentInput && (!V(Wc) || .01 < e.value)) {
                            f.J += Number(e.value);
                            Number(e.value) > f.D && (f.D = Number(e.value));
                            f.F += 1;
                            var g = Zf(e, c, d);
                            g && (f.o += e.value, f.S++);
                            if (5E3 < e.startTime - f.R || 1E3 < e.startTime - f.U) f.R = e.startTime, f.g = 0, f.h = 0;
                            f.U = e.startTime;
                            f.g += e.value;
                            g && (f.h += e.value);
                    ...
                    case "first-input":
                        ...
                        break;
                    case "longtask":
                        e = Math.max(0, e.duration - 50), a.s += e, a.C = Math.max(a.C, e), a.G += 1
                }
            })));
            return a.l
        },
        hg = function(a) {
            var b = Uf(641, function() {
                    var f = document;
                    2 == ({
                        visible: 1,
                        hidden: 2,
                        ...
                        preview: 4,
                        unloaded: 5
                    }[f.visibilityState || f.webkitVisibilityState || f.mozVisibilityState || ""] || 0) && ng(a)
                }),
                c = Uf(641, function() {
                    return void ng(a)
                });
    ...
    var ng = function(a) {
            if (!a.T) {
                ...
                window.LayoutShift && (b += Wf("cls", a.J), b += Wf("mls", a.D), b += X("nls", a.F), window.LayoutShiftAttribution && (b += Wf("cas", a.o), b += X("nas", a.S)), b += Wf("wls", a.H), b += Wf("tls", a.W), window.LayoutShiftAttribution && (b += Wf("was", a.X)));
                window.LargestContentfulPaint && (b += X("lcp", a.P), b += X("lcps", a.O));
                window.PerformanceEventTiming && a.N && (b += X("fid", a.M));
                window.PerformanceLongTaskTiming && (b += X("cbt", a.s), b += X("mbt", a.C), b += X("nlt", a.G));
                for (var c = 0, d = r(document.getElementsByTagName("iframe")), e = d.next(); !e.done; e = d.next()) Yf(e.value) && c++;
                b += X("nif", c);
                ...
                b += "&top=" + (w === w.top ? 1 : 0);
                b += a.V ? "&qqid=" + encodeURIComponent(a.V) : X("pvsid", zc(w));
        ...
        mg = function() {
            var a = [].concat(t(document.getElementsByTagName("iframe"))).filter(Yf),
                b = [].concat(t(Xf())).map(function(c) {
            ...
            jg = window.scrollX;
            kg = window.scrollY;
            return lg = [].concat(t(a), t(b)).map(function(c) {
    ...
    var rg = P(uf).g(ed.g, ed.defaultValue),
        tg = function(a, b) {
            a = void 0 === a ? null : a;
            b = void 0 === b ? !1 : b;
            Vf.call(this);
            this.h = b;
            this.g = [];
            V(gd) ? pg() && this.g.push(qg) : this.g = a || [qg];
            if (document.hasTrustToken && !V(bd) && !Array.isArray(window.goog_tt_state)) {
                var c = sg(this);
    ...
    var ug = function() {
        ...
        vg = function(a) {
            var b = W()[221],
                c = W()[150];
            return V(dd) || b && ".google.de" != c || ".google.ch" === c || "function" === typeof a.__tcfapi
        },
        sg = function(a) {
        ...
        yg = function(a, b) {
            ...
            return window.fetch(c, d).then(function(e) {
                ...
                if (e && "NoModificationAllowedError" === e.name) {
                    if (Y(a.issuerOrigin, 10), b) return xg(a)
                } else Y(a.issuerOrigin, 9)
            })
        },
        zg = function() {
            Y(qg.issuerOrigin, 13);
            return document.hasTrustToken(qg.issuerOrigin).then(function(a) {
                return a ? xg(qg) : yg(qg, !0)
            })
        },
        Ag = function(a) {
            if (document.hasTrustToken && !V(bd) && (!V(cd) || a.h)) {
                if (wg()) return window.goog_tt_promise;
                var b = [];
                V(gd) ? pg() && b.push(zg()) : a.g.forEach(function(c) {
                    Y(c.issuerOrigin, 13);
    ...
    var Bg = "platform platformVersion architecture model uaFullVersion bitness".split(" "),
        Cg = function(a) {
            return a.navigator && a.navigator.userAgentData && "function" === typeof a.navigator.userAgentData.getHighEntropyValues ? a.navigator.userAgentData.getHighEntropyValues(Bg).then(function(b) {
                var c = new jd;
                c = F(c, 1, b.platform);
                c = F(c, 2, b.platformVersion);
                c = F(c, 3, b.architecture);
                c = F(c, 4, b.model);
                c = F(c, 5, b.uaFullVersion);
                return F(c, 9, b.bitness)
            }) : null
        };
    var Dg = function() {
    ...
    Z[262] = vc("false");
    var Gg = function() {
            n(Object, "assign").call(Object, this, Z)
        },
        W = function() {
            return P(Gg)
        },
        ...
        Ig = Dg(),
        Jg = W();
    n(Object, "assign").call(Object, Jg, Ig._vars_);
    Ig._vars_ = Jg;
    var Kg = new m.WeakMap,
        Lg = function(a, b) {
            a = [a];
    ...
    function Pg() {
        ...
        1 > a || Math.floor(a) !== a ? (Bc({
            v: "2021092301"
        }, "gpt_inv_ver"), a = "1") : a = "2021092301";
        return a
    };
    var Af = function() {
        var a = {};
        this[Wd] = (a[3] = Ng, a[2] = W()[36], a[17] = function(b) {
            for (var c = [], d = 0; d < arguments.length; ++d) c[d] = arguments[d];
            return n(c, "includes").call(c, String(xc()))
        }, a[59] = function(b) {
            for (var c = [], d = 0; d < arguments.length; ++d) c[d] = arguments[d];
            d = n(c, "includes");
            var e = String,
            ...
            var h;
            g = null != (h = null == (f = jc(g.location.href.match(ic)[3] || null)) ? void 0 : f.split(".")) ? h : [];
            f = 2 > g.length ? null : "uk" === g[g.length - 1] ? 3 > g.length ? null : rc(g.splice(g.length - 3).join(".")) : rc(g.splice(g.length - 2).join("."));
            return d.call(c, e(f))
        }, a[21] = function() {
            return W()[148]
        }, a[61] = function() {
    ...
    function Qg(a) {
        var b = new af(W()[246]);
        a = new af(a);
        if (!J(b, O, 1).length && J(a, O, 1).length) {
            var c = J(a, O, 1);
            Sb(b, 1, c)
        }!J(b, cf, 2).length && J(a, cf, 2).length && (c = J(a, cf, 2), Sb(b, 2, c));
        null == D(b, 5) && null != D(a, 5) && (a = I(a, df, 5), Rb(b, 5, a));
        Cf(b)
    };
    var Rg = function(a) {
            if (a = a.scripts)
        ...
        Sg, Tg, Ug = function(a) {
            a = (null != (Tg = null == (Sg = a) ? void 0 : Sg.src) ? Tg : "").match(ic)[3] || null;
            return "pagead2.googlesyndication.com" === jc(a)
        },
        Vg = function(a) {
        ...
        Wg = function(a) {
            a = Ug(a) ? x("https://pagead2.googlesyndication.com/") : Rf;
            a = Ra([a, Qf, x("2021092301"), x(".js")]);
            var b = vf(Sc);
        ...
        Yg = function(a, b, c) {
            a.g = b;
            a.h = c;
            for (var d = r(a.i), e = d.next(); !e.done; e = d.next()) e = e.value, e(b, c);
            a.i.length = 0
        },
        Zg = function(a, b, c) {
            var d = a.location.host,
                e = b && lc(b.src, "domain"),
                f = b && lc(b.src, "network-code");
            if (!d && !e && !f) return Yg(c, void 0, new a.Error("no provided or inferred data")), null;
            a = Ug(b) ? x("https://pagead2.googlesyndication.com") : x("https://securepubads.g.doubleclick.net");
            return Qa(Ra([a, x("/pagead/ppub_config")]), {
                ippd: d,
                pppd: e,
                pppnc: f
            })
        ...
        $g = function(a, b) {
            ...
            b && (c.open("GET", b.toString(), !0), c.withCredentials = !1, c.onload = function() {
                300 > c.status ? (Sf("13", a), Yg(d, 204 == c.status ? "" : c.responseText)) : Yg(d, void 0, new a.Error("resp:" + c.status))
            }, c.onerror = function() {
                return Yg(d, void 0, new a.Error("s:" + c.status + " rs:" + c.readyState))
            }, c.send())
        },
        ah = function(a, b, c, d) {
            Hg(172, d);
            ...
            P(Re).g(5);
            ug();
            V(cd) && vg(c) || (a = new tg(null, !0), 0 < vf(hd) ? Hg(258, Ag(a)) : Ag(a));
            (a = Cg(c)) && a.then(function(e) {
                return Hg(251, Ub(e))
            });
            Pf(c.document);
            Ff(c.document)
        ...
        bh = function(a, b, c) {
            ...
            if (!d._loadStarted_) {
                ...
                var g = fc(document, "SCRIPT");
                g.src = dc(a);
                ec(g);
                g.async = !0;
                var h = c.head || c.body || c.documentElement;
                "complete" !== e.document.readyState && d.fifWin ? Fg(e, function() {
                    return void h.appendChild(g)
                }) : h.appendChild(g);
                d._loadStarted_ = !0
            }
            var k;
            e === e.top && (W()[259] || !b.currentScript && (null == (k = Rg(b)) ? 0 : k.async)) && (xd(e), $g(e, f))
        };
    var ch;
    a: {
        try {
        ...
        var d = new Lf(null, "gpt_exception", .01);
        Mf(d, function(e) {
            e.methodId = 420
        });
        Nf(d, function() {
    ...
    [
        ...
        [1936, null, null, [1]],
        [null, null, null, [null, null, null, ["criteo", "index", "indextest", "openx", "openxtest", "pubcid.org", "pubmatic", "thetradedesktest"]], null, 1918],
    ...
    [
        [20, [
            ...
            ], null, null, null, null, null, null, null, 108]
        ]],
        [4, [
            [null, [
                [44714449, [
        ...
        [3, [
            ...
            [20, [
                    [31060544],
                    [31060545, [
                        [null, null, 363931022, [null, null, ""]]
                    ]]
                ],
            ...
            [1000, [
                    [31061424, null, [4, null, 6, null, null, null, null, ["31061422"]]],
            ...
            [1, [
                [31062346],
                [31062347, [
                    [null, 357045128, null, [null, 1]]
                ]],
                [31062348, [
                    [null, 357045128, null, [null, 2]]
                ]]
            ]],
            [50, [
                [31062463],
        ...
        [5, [
            ...
            [1000, [
                    [31063001, [
                            [null, 24, null, [null, 31063001]],
                            [null, 25, null, [null, 31063001]]
                        ],
                        [6, null, null, 4, null, 8]
                    ],
                    [31063002, [
                            [null, 24, null, [null, 31063002]],
                            [null, 25, null, [null, 31063002]]
                        ],
        ...
        [2, [
            [1000, [
                    [31060202, null, [4, null, 6, null, null, null, null, ["31060200"]]],
                    [31060203, null, [4, null, 6, null, null, null, null, ["31060201"]]]
                ],
                [4, null, 51]
            ],
            [10, [
            ...
            [1000, [
                    [31061029, null, [4, null, 6, null, null, null, null, ["31060978"]]],
                    [31061030, null, [4, null, 6, null, null, null, null, ["31060979"]]]
                ],
                [4, null, 12]
            ],
            [10, [
    ...
    ], null, null, [0.001, 1000, null, 1000]
])