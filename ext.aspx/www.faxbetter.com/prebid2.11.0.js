        ...
        var i = t(0),
            ...
            n = {
                ...
                isBidRequestValid: function(e) {
                    return e.params && !!e.params.aid
                },
                buildRequests: function(e, r) {
                    var t = {};
                    return r && r.refererInfo && (t.referer = encodeURIComponent(r.refererInfo.referer)), t.tags = [], i._each(e, (function(e) {
                        var r = {
                            id: e.bidId,
                            sizes: e.sizes,
                            aid: e.params.aid
                        ...
                        method: "POST",
                        url: "//prebid.admedia.com/bidder/",
                        data: JSON.stringify(t)
                    }
                },
                interpretResponse: function(e, r) {
                    var t = [];
                    return e.body.tags && i._each(e.body.tags, (function(e) {
                        if (!e.error && 0 < e.cpm) {
                            var r = {
                                requestId: e.id,
                                cpm: e.cpm,
    ...
    248: function(e, r, i) {
        ...
        var c = i(0),
            ...
            n = {
                ...
                isBidRequestValid: function(e) {
                    if (!e || !e.params) return c.logWarn(s + ": Missing bid parameters"), !1;
                    if (!c.isStr(e.params.site_id)) return c.logWarn(s + ": site_id must be specified as a string"), !1;
                    if (v(e))
                        if (e.params.mimes) {
                            if (!c.isArray(e.params.mimes) || !e.params.mimes.every((function(e) {
                                    return c.isStr(e)
                                }))) return c.logWarn(s + ": mimes must be an array of strings"), !1
                        } else c.logWarn(s + ": mimes should be specified for videos");
                    return !0
                },
                buildRequests: function(e, r) {
                    var i = c.getTopWindowLocation(),
                        a = i.href,
                        d = "https:" === i.protocol ? 1 : 0,
                        p = "",
                        m = "",
                        u = null,
                        t = e.map((function(e) {
                            var r = c.getBidIdParameter("bidfloor", e.params),
                                i = d || (c.getBidIdParameter("secure", e.params) ? 1 : 0);
                            p = c.getBidIdParameter("site_id", e.params), m = e.auctionId;
                            var a = {
                                id: e.bidId,
                                secure: i,
                                bidfloor: r || 0,
                            ...
                            if (l(e.params.tag_id, a, "tagid"), v(e)) {
                                var t = c.deepAccess(e, "mediaTypes.video") || {},
                                    s = g(t.playerSize || e.sizes),
                                    n = {};
                                s && s[0] && (l(s[0].w, n, "w"), l(s[0].h, n, "h")), l(e.params.position, n, "pos"), l(e.params.mimes || t.mimes, n, "mimes"), l(e.params.maxduration, n, "maxduration"), l(e.params.protocols || t.protocols, n, "protocols"), l(e.params.api || t.api, n, "api"), a.video = n
                            } else {
                                var o = {
                                    format: g((c.deepAccess(e, "mediaTypes.banner") || {}).sizes || e.sizes)
                                };
                                l(e.params.position, o, "pos"), a.banner = o
                            }
                            return e.crumbs && e.crumbs.pubcid && (u = e.crumbs.pubcid), a
                        })),
                        s = {
                            id: m,
                            imp: t,
                        ...
                        n = {};
                    return r && r.gdprConsent && (n.consent = r.gdprConsent.consentString, "boolean" == typeof r.gdprConsent.gdprApplies && (s.regs = {
                        ext: {
                            gdpr: r.gdprConsent.gdprApplies ? 1 : 0
                        }
                    })), u && (n.fpc = u), c.isEmpty(n) || (s.user = {
                        ext: n
                    }), {
                        method: "POST",
                ...
                interpretResponse: function(n, e) {
                    var o = [],
                        d = {};
                    return n = n.body, e && e.data && e.data.imp && c._each(e.data.imp, (function(e) {
                        return d[e.id] = e
                    })), n && c.isArray(n.seatbid) && c._each(n.seatbid, (function(e) {
                        c._each(e.bid, (function(e) {
                            ...
                            if (0 < r && e.impid) {
                                ...
                                t.video ? (s.vastUrl = i, s.mediaType = "video", s.width = t.video.w, s.height = t.video.h) : (s.ad = i + '<img src="' + a + '" />', s.width = e.w, s.height = e.h), o.push(s)
                            }
                        }))
                    })), o
                },
        ...
        function v(e) {
            return "video" === e.mediaType || !!c.deepAccess(e, "mediaTypes.video")
        }
...
pbjsChunk([69], {
    ...
    495: function(e, t, r) {
        ...
        function n(e) {
            if (!(e.requestId && e.cpm && e.creativeId && e.ttl && e.currency)) return !1;
            switch (e.mediaType) {
                case c.b:
                ...
                case c.c:
                    return Boolean(e.title && e.image && e.impressionTrackers);
                default:
                    return !1
            }
        }
        var i = {
            ...
            buildRequests: function() {
                var e = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : [],
                    t = window;
                try {
                    window.top.location.toString(), t = window.top
                } catch (e) {
                    d.logMessage(e)
                }
                for (var r = d.getTopWindowLocation(), a = [], n = {
                        deviceWidth: t.screen.width,
                        deviceHeight: t.screen.height,
                        language: navigator && navigator.language ? navigator.language : "",
                        secure: "https:" === r.protocol ? 1 : 0,
                        host: r.host,
                        page: r.pathname,
                        placements: a
                    }, i = e.length, o = 0; o < i; o++) {
                    var s = e[o];
                    a.push({
                        placementId: s.params.placementId,
                        bidId: s.bidId,
                        traffic: s.params.traffic || c.b
                    })
                }
                return {
                    method: "POST",
                    url: "//ssp-nj.webtradehub.com/?c=o&m=multi",
                    data: n
                }
            },
            interpretResponse: function(e) {
                ...
                for (var r = 0; r < e.length; r++) {
                    var a = e[r];
                    n(a) && (delete a.mediaType, t.push(a))
                }
                return t
            },
            getUserSyncs: function(e, t) {
                return [{
                    type: "image",
                    url: "//ssp-nj.webtradehub.com/?c=o&m=cookie"
                }]
            }
        };
